...
DC_Operation_S001 [Part1] 
    ...
    ...    ${DC_Operation_S001['parcel_type']}
    ...    ${DC_Operation_S001['booking_name']}
    ...
    common.Verify Capture Screenshot    DC_Operation_S001    Verify Display Import File Popup