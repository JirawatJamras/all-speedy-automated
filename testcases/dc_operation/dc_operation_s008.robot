...
DC_Operation_S008
    ...
    ${pouch_number}=    Set Variable    P112430045
    ...
    # ...    ${today}
    # ...    ขนส่งเข้ารับพัสดุแล้ว    #${DC_Operation_S008.wait_derivery_data_list['status']}
    ...
    # common.Verify Capture Screenshot    dc_operation    DC_Operation_S008    36.Verify Data List Wait Scan In Warehouse AC
