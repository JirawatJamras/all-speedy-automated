...
DC_Operation_S008
    ...
    # ${tracking_g}    Get Parcel Codes By Sender Name    ${ParcelsData}    ${DC_Operation_S008['sender_name']}
    ${tracking_g}=    Set Variable    SPBD241100010913
    ...
    ...    ${tracking_g}
    ...    ${DC_Operation_S008.parcel_detail_in_scan_in_tab['customer_id']}
    ...    ${DC_Operation_S008.parcel_detail_in_scan_in_tab['parcel_size']}
    ...    ${DC_Operation_S008.parcel_detail_in_scan_in_tab['parcel_status']}
    ...    ${DC_Operation_S008.parcel_detail_in_scan_in_tab['courier']}
    ...    ${DC_Operation_S008.parcel_detail_in_scan_in_tab['pouch_number']}
    ...    ${DC_Operation_S008.parcel_detail_in_scan_in_tab['receiving_date']}
    ...    ${DC_Operation_S008.parcel_detail_in_scan_in_tab['origin_warehouse']}
    ...    HOME (11120)    # ${DC_Operation_S008.parcel_detail_in_scan_in_tab['send_parcel_to']}
    ...
    ...    ${DC_Operation_S008.label_detail_in_scan_in_tab['courier']}
    ...    ${DC_Operation_S008.label_detail_in_scan_in_tab['zipcode']} 
    ...    ${DC_Operation_S008.label_detail_in_scan_in_tab['customer']}
    ...    ${DC_Operation_S008.label_detail_in_scan_in_tab['phone']}
    ...    ${dc_operation.scan_in_title_label_detail['size_home']}    
    ...    ${DC_Operation_S008.label_detail_in_scan_in_tab['size']}
    ...
    ...    ${DC_Operation_S008.sender_data_in_scan_in_tab['name']}
    ...    ${DC_Operation_S008.sender_data_in_scan_in_tab['phone']}
    ...    ${DC_Operation_S008.sender_data_in_scan_in_tab['shipping_origin']}
    ...    ${DC_Operation_S008.sender_data_in_scan_in_tab['address']}
    ...
    ...    ${DC_Operation_S008.receiver_data_in_scan_in_tab['name']}
    ...    ${DC_Operation_S008.receiver_data_in_scan_in_tab['phone']}
    ...    ${DC_Operation_S008.receiver_data_in_scan_in_tab['shipping_destination']}
    ...    ${DC_Operation_S008.receiver_data_in_scan_in_tab['address']}
    ...
    # Defect201    Defect214
    # Expected
    dps_history_parcel_page.Verify Timeline  ${DC_Operation_S008['timeline_in_history_parcel_after_scan_in']}
    ...
    ...    ${dc_operation.title['homepage']}
    dps_home_page.Verify Data In All Task Tab
    ...    ${DC_Operation_S008.data_in_all_task_tab_after_scan['task_type']}
    ...
    ...    ${DC_Operation_S008.data_in_all_task_tab_after_scan['export_to']}
    ...
    ...    ${tracking_g}
    ...    ร้านรับพัสดุเข้าระบบ  # ${DC_Operation_S008.data_in_all_task_tab_after_scan['parcel_status']}
    common.Scroll Window To Vertical    0
    ...
    Switch Window    NEW
    # Expected
    dps_history_parcel_page.Verify Timeline  ${DC_Operation_S008['timeline_in_history_parcel_after_scan_out']}
    ...
    Log    Step No.42 ค้นหาหมายเลข Tracking และ คลิกไอคอนรูปดินสอ ด้านหลังรายการ Tracking นั้น
    dps_history_parcel_page.Filter Data By Parcel Number    ${tracking_g}
    dps_history_parcel_page.Click Edit History Parcel    ${tracking_g}
    Switch Window    NEW
    # Expected
