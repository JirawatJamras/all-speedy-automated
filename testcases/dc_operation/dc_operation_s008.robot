...
DC_Operation_S008
    ...
    ${tracking_g}=    Set Variable    SPBD241100022583    # Hard code for development.
    ...
    ...    CPALL    #${DC_Operation_S008.scan_out_waiting_scan['transport']}
    ...    ${DC_Operation_S008.scan_out_waiting_scan['parcel_owner']}
    ...
    # Expected
    dps_history_parcel_page.Verify History Parcel Page    ${dc_operation.title['history_parcel']}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S008    Verify History Parcel Page After Scan Out 1
    ...
    ...    ${DC_Operation_S008.wait_derivery_data_list['transport']}
    ...    ${today}
    ...    ขนส่งเข้ารับพัสดุแล้ว    # ${DC_Operation_S008.wait_derivery_data_list['status_after_print']}
    ...
    ...    ${DC_Operation_S008.scan_in_data_waiting_scan_warehouse_ac['tracking_number']}
    ...    ${pouch_number}
    ...    คลัง DC BB    #${DC_Operation_S008.scan_in_data_waiting_scan_warehouse_ac['receive_parcel_from']}
    ...    ${DC_Operation_S008.scan_in_data_waiting_scan_warehouse_ac['parcel_size']}
    ...    ${today}
    ...    ${DC_Operation_S008.scan_in_data_waiting_scan_warehouse_ac['parcel_status']}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S008    Verify Data List Wait Scan In Warehouse AC
    ...
    # Expected
    dps_history_parcel_page.Verify History Parcel Page    ${dc_operation.title['history_parcel']}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S008    Verify History Parcel Page After Scan Out 2
    ...
    # Expected
    dps_history_parcel_page.Verify History Parcel Page    ${dc_operation.title['history_parcel']}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S008    Verify History Parcel Page After Scan Out 3
    ...
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S008    Verify Scan In Page After Scan Pouch At RDC LP Warehouse
    ...
    ...    ${dc_operation.scan_in_title_label_detail['wh']}
    dps_scan_page.Verify Data Label Parcel In Scan Page [CP All Courier]
    ...    ${DC_Operation_S008.scan_in_data_label_detail['store']}
    ...    ${DC_Operation_S008.scan_in_data_label_detail['customer']}
    ...    ${DC_Operation_S008.scan_in_data_label_detail['phone']}
    ...    ${pouch_number}
    ...    DC BB - RDC LP    #${DC_Operation_S008.scan_in_data_label_detail['wh']}
    ...    ${DC_Operation_S008.scan_in_data_label_detail['symbol']}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S008    Data Parcel Details In Scan Page
    dps_scan_page.Verify Title Sender In Scan Page
    ...    ${dc_operation.scan_in_title_sender_detail['title']}
    ...    ${dc_operation.scan_in_title_sender_detail['name']}
    ...    ${dc_operation.scan_in_title_sender_detail['phone']}
    ...
    ...    -    #${DC_Operation_S008.scan_in_sender_data['shipping_origin']}
    ...    ${DC_Operation_S008.scan_in_sender_data['address']}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S008    Data Sender Details In Scan Page
    dps_scan_page.Verify Title Receiver In Scan Page
    ...    ${dc_operation.scan_in_title_receiver_detail['title']}
    ...    ${dc_operation.scan_in_title_receiver_detail['name']}
    ...    ${dc_operation.scan_in_title_receiver_detail['phone']}
    ...
    ...    ${DC_Operation_S008.scan_in_receiver_data['address']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S008    Verify Data Receiver In Scan Page
    ...
    # Expected
    dps_history_parcel_page.Verify History Parcel Page    ${dc_operation.title['history_parcel']}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S008    Verify History Parcel Page After Scan Out 4
    ...
    # Expected
    dps_history_parcel_page.Set Pouch Number In Timeline List    ${DC_Operation_S008['timeline_in_history_parcel']}    สเเกนเข้า POUCH    ${pouch_number}
    dps_history_parcel_page.Verify Timeline  ${DC_Operation_S008['timeline_in_history_parcel']}    9    # 12
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S008    Verify Timeline After Scan Out
    Close Window
    Switch Window    MAIN
