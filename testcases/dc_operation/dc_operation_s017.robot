...
DC_Operation_S017
    ...
    Log    Step No.2 ปิด Pouch ที่มีปลายทางเป็น RDC LP (ทำทีละรายการจดหมด)
    ...
    dps_history_parcel_page.Filter Data By Parcel Number    SPBD241100010193
    # Expected
    ...
    dps_history_parcel_page.Click Edit History Parcel    SPBD241100010193
    Switch Window    NEW
    # Defect209    Defect210
    # Expected
