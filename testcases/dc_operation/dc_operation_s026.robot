...
DC_Operation_S026
    ...
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S026    1.1.Data Parcel Details In Scan Page
    ...
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S026    1.2.Data Sender Details In Scan Page
    ...
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S026    1.3.Data Receiver Details In Scan Page
    ...
    ...    ${pouch_number}
    ...    ${dc_operation.label_pouch_detail['default_number_of_parcel']}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S026    5.1.Verify Pouch Detail After Click Pouch Box 2nd Time
    ...
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S026    5.2.Verify Parcel Details After Click Pouch Box 2nd Time
    ...
    ...    ${pouch_number}
    ...    ${DC_Operation_S026.pouch['number_of_parcel']}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S026    6.1.Verify Pouch Detail After Click Pouch Box 3rd Time
    Scroll Window To Vertical    0
    dps_scan_page.Verify Pouch Number Data Parcel Details In Scan Page [CP All Courier]    ${pouch_number}
    dps_scan_page.Verify Pouch Number Data Label Parcel In Scan Page [CP All Courier]    ${pouch_number}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S026    6.2.Verify Parcel Details After Click Pouch Box 3rd Time
    ...
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S026    11.1.Verify Parcel Details In Warehouse
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S026    11.2.Verify Sender And Receiver In Warehouse
