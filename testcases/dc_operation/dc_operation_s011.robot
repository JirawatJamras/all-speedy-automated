...
DC_Operation_S011
    ...
    ${parcel_j}=    Set Variable    SPBD241100012629
    ...
    ...    0959494989    # Expected Result is (เบอร์โทรที่ระบุในไฟล์ Excel Template ขั้นตอน Booking)
    ...    ${DC_Operation_S011.scan_in_data_parcel_detail['pouch_number']}
    ...
    ...    0900987354    # Expected Result is ${DC_Operation_S011.sender_data_in_scan_in_tab['phone']}
    ...
    # ...    14-11-2567    #${DC_Operation_S011.wait_derivery_data_list['date']}
    ...
    ...    Home    #${DC_Operation_S011.wait_derivery_data_list['export_to']}
    ...    Flash    #${DC_Operation_S011.wait_derivery_data_list['transport']}
    ...    19-11-2567    #${DC_Operation_S011.wait_derivery_data_list['date']}
    ...    ${DC_Operation_S011.wait_derivery_data_list['status']}
    sleep    5s
