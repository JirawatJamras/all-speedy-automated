...
DC_Operation_S011
    ...
    ${tracking_j}=    Set Variable    SPBD241100021162
    ...
    # common.Scroll Window To Vertical    0
    # common.Verify Capture Screenshot    dc_operation    DC_Operation_S011    Verify Value Waiting List To Scan Out [Scan Out Page] 1
    # Sleep    1s
    # common.Scroll Window To Vertical    1000
    # common.Verify Capture Screenshot    dc_operation    DC_Operation_S011    Verify Value Waiting List To Scan Out [Scan Out Page] 2
    ...
    # ...    ${DC_Operation_S011.scan_in_value_waiting_scan_warehouse_ac['parcel_size']}
    # ...    2024-11-25
    # ...    ${DC_Operation_S011.scan_in_value_waiting_scan_warehouse_ac['parcel_status']}
