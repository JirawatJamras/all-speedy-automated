...
DC_Operation_S009
    ...
    # ...    ${DC_Operation_S009.scan_in_data_parcel_detail['tracking']}
    ...
    # ...    ${DC_Operation_S009.scan_in_data_parcel_detail['receiving_date']}
    # ...    ${DC_Operation_S009.scan_in_data_parcel_detail['warehouse_source']}
    # ...    HOME (11120)    # ${DC_Operation_S009.scan_in_data_parcel_detail['send_parcel_to']}
    ...
    # ...    ${DC_Operation_S009.scan_in_data_label_detail['courier']}
    ...
    # ...    ${DC_Operation_S009.scan_in_data_label_detail['size']}
