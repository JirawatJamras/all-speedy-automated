...
DC_Operation_S015
    ...
    # Defect158    Defect159    Defect160    Defect253
    # Expected    
    # Inprogress
    ...
    ...    ${DC_Operation_S015.parcel_detail_in_scan_in_tab['parcel_status']}
    ...    ${courier}
    ...    ${DC_Operation_S015.parcel_detail_in_scan_in_tab['pouch_number']}
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S014    Verify Section Waiting List To Scan Out [Scan Out Page] 1
    Sleep    1s
    common.Scroll Window To Vertical    1000
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S014    Verify Section Waiting List To Scan Out [Scan Out Page] 2
