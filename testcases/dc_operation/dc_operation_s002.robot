...
DC_Operation_s002
    ...
    Step Test:    Step No.19_1 เข้าสู่ระบบ
    ...
    Step Test:    Step No.19_2 เลือก role แอดมินคลัง
    ...
    Step Test:    Step No.20 เลือกเมนู "ตรวจสอบรอบเข้ารับพัสดุ"
    ...
    Step Test:    Step No.21 คลิกแท็บ "รายการรอคลังยืนยัน"
    ...
    Step Test:    Step No.22 คลิกไอคอนรูปดินสอ ด้านขวาสุดของรายการ
    ...
    Step Test:    Step No.23 คลิกปุ่ม Export
    ...
    Step Test:    Step No.24 คลิกปุ่ม อนุมัติ
    ...
    Step Test:    Step No.25 กลับ Speed D "เรียกรถเข้ารับพัสดุ"
    Go To    ${B2C_UAT_URL}
    register_general_customers_page.Select Business Customers Tab
    b2c_login_page.Input Email                    ${b2c_login_user_01['username']}
    b2c_login_page.Input Password                 ${b2c_login_user_01['password']}
    ...
    Step Test:    Step No.26 เลือกเมนู "จองการจัดส่งพัสดุ"
    b2c_home_page.Click Book Parcel Delivery    
    # Defect199
    # Expected
    # b2c_booking_delivery_page.Verify Booking Status After Cut Off Time    
