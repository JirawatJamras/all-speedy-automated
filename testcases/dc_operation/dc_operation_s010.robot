...
DC_Operation_S010
    ...
    ${tracking_i}=    Set Variable    SPBD241100016761
    ${pouch_number}=    Set Variable    P112467382
    ...
    ...    ${DC_Operation_S010.data_in_all_task_tab['task_type']}
    ...    speedy  # ${DC_Operation_S010.data_in_all_task_tab['parcel_owner']}
    ...    home  # ${DC_Operation_S010.data_in_all_task_tab['import_from']}
    ...    ${DC_Operation_S010.data_in_all_task_tab['export_to']}
    ...    CPALL  # ${DC_Operation_S010.data_in_all_task_tab['transport']}
    ...    ${DC_Operation_S010.data_in_all_task_tab['pouch_number']}
    ...    ${tracking_i}
    ...    ร้านรับพัสดุเข้าระบบ  # ${DC_Operation_S010.data_in_all_task_tab['parcel_status']}
    ...
    ...    home  # ${DC_Operation_S010.data_in_import_task_tab['import_from']}
    ...
    ...    ${tracking_i}
    ...    ${DC_Operation_S010.parcel_detail_in_scan_in_tab['customer_id']}
    ...    ${DC_Operation_S010.parcel_detail_in_scan_in_tab['parcel_size']}
    ...    ${DC_Operation_S010.parcel_detail_in_scan_in_tab['parcel_status']}
    ...    ${DC_Operation_S010.parcel_detail_in_scan_in_tab['courier']}
    ...    ${DC_Operation_S010.parcel_detail_in_scan_in_tab['pouch_number']}
    ...    ${DC_Operation_S010.parcel_detail_in_scan_in_tab['receiving_date']}
    ...    ${DC_Operation_S010.parcel_detail_in_scan_in_tab['origin_warehouse']}
    ...    HOME (11120)    # ${DC_Operation_S010.parcel_detail_in_scan_in_tab['send_parcel_to']}
    ...
    ...    ${DC_Operation_S010.label_detail_in_scan_in_tab['courier']}
    ...    ${DC_Operation_S010.label_detail_in_scan_in_tab['zipcode']} 
    ...    ${DC_Operation_S010.label_detail_in_scan_in_tab['customer']}
    ...    ${DC_Operation_S010.label_detail_in_scan_in_tab['phone']}
    ...    ${dc_operation.scan_in_title_label_detail['size_home']}    
    ...    ${DC_Operation_S010.label_detail_in_scan_in_tab['size']}
    ...
    ...    ${DC_Operation_S010.sender_data_in_scan_in_tab['name']}
    ...    ${DC_Operation_S010.sender_data_in_scan_in_tab['phone']}
    ...    ${DC_Operation_S010.sender_data_in_scan_in_tab['shipping_origin']}
    ...    ${DC_Operation_S010.sender_data_in_scan_in_tab['address']}
    ...
    ...    ${DC_Operation_S010.receiver_data_in_scan_in_tab['name']}
    ...    ${DC_Operation_S010.receiver_data_in_scan_in_tab['phone']}
    ...    ${DC_Operation_S010.receiver_data_in_scan_in_tab['shipping_destination']}
    ...    ${DC_Operation_S010.receiver_data_in_scan_in_tab['address']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S010    Verify Sender Data In Scan In
    ...
    ...    ${dc_operation.title['homepage']}
    dps_home_page.Verify Data In All Task Tab
    ...    ${DC_Operation_S010.data_in_all_task_tab_after_scan['task_type']}
    ...    speedy  # ${DC_Operation_S010.data_in_all_task_tab_after_scan['parcel_owner']}
    ...    home  # ${DC_Operation_S010.data_in_all_task_tab_after_scan['import_from']}
    ...    ${DC_Operation_S010.data_in_all_task_tab_after_scan['export_to']}
    ...    CPALL  # ${DC_Operation_S010.data_in_all_task_tab_after_scan['transport']}
    ...    ${DC_Operation_S010.data_in_all_task_tab_after_scan['pouch_number']}
    ...    ${tracking_i}
    ...    ร้านรับพัสดุเข้าระบบ  # ${DC_Operation_S010.data_in_all_task_tab_after_scan['parcel_status']}
    common.Scroll Window To Vertical    0
    ...
    ...    DCSB  # ${DC_Operation_S010.data_in_export_task_tab['import_from']}
    ...
    ...    ${tracking_i}
    ...    ${pouch_number}
    ...    คลัง DC BB    #${DC_Operation_S010.scan_out_waiting_scan['receive_parcel_from']}
    ...    CP ALL    #${DC_Operation_S010.scan_out_waiting_scan['transport']}
    ...    ${DC_Operation_S010.scan_out_waiting_scan['parcel_owner']}
    ...    กล่อง XL    #${DC_Operation_S010.scan_out_waiting_scan['parcel_size']}
    ...    07/11/2567
    ...    พัสดุรอ Scan out ไปคลัง DC SB    #${DC_Operation_S010.scan_out_waiting_scan['parcel_status']}
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S010    Verify Section Waiting List To Scan Out [Scan Out Page] 1
    Sleep    1s
    common.Scroll Window To Vertical    1000
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S010    Verify Section Waiting List To Scan Out [Scan Out Page] 2

    Log    Step No.18 กรอกหมายเลขพัสดุ (Tracking) ที่มีชื่อผู้ส่งเป็น "คุณ i" และ กดค้นหา หรือกด Enter
    dps_scan_page.Input Pouch Number [Scan Out Page]    ${tracking_i}
    ...
    ...    ${pouch_number}
    ...    ${EMPTY}    #${DC_Operation_S010.data_in_pouch_detail['crossdock_warehouse']}
    ...
    ...    ${DC_Operation_S010.data_in_pouch_detail['label_simbol']}
    ...    ${pouch_number}
    ...
    ...    พัสดุรอ Scan out ไปคลัง DC SB    #${DC_Operation_S010.scan_out_waiting_scan['parcel_status']}
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S010    Verify Section Waiting List To Scan Out After Close Pouch [Scan Out Page] 1
    Sleep    1s
    common.Scroll Window To Vertical    1000
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S010    Verify Section Waiting List To Scan Out After Close Pouch [Scan Out Page] 2
    ...
    ...    ${DC_Operation_S010.wait_derivery_data_list['date']}
    ...
    ...    ${DC_Operation_S010.wait_derivery_data_list['export_to']}
    ...    ${DC_Operation_S010.wait_derivery_data_list['transport']}
    ...    16-11-2567    #${DC_Operation_S010.wait_derivery_data_list['date']}
    ...    ${DC_Operation_S010.wait_derivery_data_list['status']}
    ...
    ...    ${tracking_i}
    ...    ${DC_Operation_S010.scan_in_value_waiting_scan_warehouse_ac['pouch_number']}
    ...    ${DC_Operation_S010.scan_in_value_waiting_scan_warehouse_ac['receive_parcel_from']}
    ...    ${DC_Operation_S010.scan_in_value_waiting_scan_warehouse_ac['parcel_size']}
    ...    2024-11-18
    ...    ${DC_Operation_S010.scan_in_value_waiting_scan_warehouse_ac['parcel_status']}
    ...
    Log    Step No.51 เลือกแท็บงานรับเข้า
    dps_home_page.Select Tab Import Task
    # Defect139
    # Expected
    dps_home_page.Verify Label In Import Task Tab
    ...
    Log    Step No.52 เข้าเมนู Scan, กรอกหมายเลขพัสดุ (Tracking) ที่มีชื่อผู้ส่งเป็น "คุณ i" และ กดค้นหา หรือกด Enter
    dps_home_page.Select DPS Menu    ${dc_operation.dps_menu['scan']}
    ...
    Log    Step No.53 คลิกปุ่มตกลง
    dps_scan_page.Click Agree On Parcel Is On Pouch Warning Popup
    # Expected
    dps_scan_page.Verify Navigate To Scan Page And Stay At Scan In Tab
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S010    Verify Navigate To Scan Page After Close Parcel Is On Pouch Warning Popup

    Log    Step No.54 กรอกหมายเลข Pouch และ คลิกปุ่มตกลง หรือ Enter
    dps_scan_page.Input Pouch Number [Scan In Page]    ${pouch_number}
    dps_scan_page.Click Search Button [Scan In Page]
    # Expected
    ...
    Log    Step No.55 คลิกปุ่มตกลง
    dps_scan_page.Click Confirm Button On Unbox Pouch And Scan Piece By Piece Popup
    # Expected
    #

    Log    Step No.56 กรอกหมายเลขพัสดุ (Tracking) ที่มีชื่อผู้ส่งเป็น "คุณ i" ในช่องค้นหาด้านล่างรายละเอียด Pouch และ กดค้นหา หรือกด Enter
    ...
    Log    Step No.57 คลิกปุ่ม ยืนยัน Scan in
    ...
    Log    Step No.59 คลิกเมนู "ประวัติพัสดุภายในคลัง" ที่แถบเมนูด้านซ้าย
    dps_home_page.Select DPS Menu    ${dc_operation.dps_menu['history_parcel']}
    # Expected
    dps_history_parcel_page.Verify History Parcel Page    ${dc_operation.title['history_parcel']}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S010    Verify History Parcel Page After Scan Out

    Log    Step No.60 ค้นหาหมายเลข Tracking และ คลิกไอคอนรูปดินสอ ด้านหลังรายการ Tracking นั้น
    dps_history_parcel_page.Filter Data By Parcel Number    ${tracking_i}
    dps_history_parcel_page.Click Edit History Parcel    ${tracking_i}
    Switch Window    NEW
    # Expected
    ...
    Log    Step No.62 เลือกแท็บงานนำจ่าย
