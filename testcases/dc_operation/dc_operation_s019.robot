...
DC_Operation_S019
    ...
    ...    ${call_car_pick_up.text_parcel_id_start_with['chilled']}
    ...    ${DC_Operation_S019['parcel_number']}
    common.Verify Capture Screenshot    DC_Operation_S019    Verify Parcel Status After Cut Off Time
    b2c_home_page.Click Book Parcel Delivery    
    # Expected
    ...
    common.Verify Capture Screenshot    DC_Operation_S019    Verify Booking Status After Cut Off Time
    ...
    common.Verify Capture Screenshot    DC_Operation_S019    Verify Homepage Title
    ...
    common.Verify Capture Screenshot    DC_Operation_S019    Verify Role Change In Profile
    ...
    common.Verify Capture Screenshot    DC_Operation_S019    Verify Check Receiving Cycle Page
