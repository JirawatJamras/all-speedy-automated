...
DC_Operation_S020
    ...
    # Expected
    Sleep    2
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020    Verify Login Page
    ...
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020   Verify Call Car Pick Up Page
    ...
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020   Verify Parcel Pickup Schedule Popup

Log    Step No.5 ระบุข้อมูล
    ${tomorrow}    Set Tomorrow Date
    ${today}    Set Today
    b2c_call_car_pick_up_parcel_page.Select Parcel Type    ${DC_Operation_S020['parcel_type']}
    b2c_call_car_pick_up_parcel_page.Select Parcel Pickup Date    ${tomorrow}
    b2c_call_car_pick_up_parcel_page.Select Parcel Pickup Time    ${DC_Operation_S020['parcel_pickup_time']}
    ...
    ...    ${DC_Operation_S020.call_car_pick_up['receiving_type']}
    ...    ${tomorrow}
    ...    ${DC_Operation_S020['verify_pickup_time']}
    ...    ${call_car_pick_up['text_parcel_pickup_date']}
    ...
    ...    ${DC_Operation_S020.call_car_pick_up['company_address']}
    ...    ${DC_Operation_S020.call_car_pick_up['sub_district']}
    ...    ${DC_Operation_S020.call_car_pick_up['district']}
    ...    ${DC_Operation_S020.call_car_pick_up['province']}
    ...    ${DC_Operation_S020.call_car_pick_up['postcode']}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020   Verify Add Special Pickup Round Success
    ...
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020    Verify Booking Page
    ...
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020    Verify Term & Condition

    Step Test:    Step No.8 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    # Expected   
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020    Verify Select Parcel Type

    Step Test:    Step No.9 กดปุ่ม "พัสดุทั่วไป"
    b2c_booking_delivery_page.Select Parcel Type    ${DC_Operation_S020['parcel_type']}
    # Expected
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020    Verify Create Parcel Page Sender Step
    ...
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020    Verify Booking Detail Page
    ...
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020    Verify Edit Booking Popup
    ...
    ...    ${DC_Operation_S020.call_car_pick_up['car_type']}
    ...    ${tomorrow}
    ...    ${call_car_pick_up.default['parcel_number']}
    ...    ${today}
    ...    ${call_car_pick_up.default['price']}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020    Verify Display Pickup Schedule Data
    ...
    ...    ${today}
    ...    ${DC_Operation_S020['shipping_origin']}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020    Verify Complete Select Parcel Pickup Schedule And Save
    ...
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020    Verify Import File Popup
    ...
    ...    ${DC_Operation_S020['parcel_number']}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020    Verify Import File Success
    ...
    ...    ${call_car_pick_up.text_parcel_id_start_with['chilled']}
    ...    ${DC_Operation_S020['parcel_number']}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020    Verify Parcel Status After Cut Off Time
    b2c_home_page.Click Book Parcel Delivery    
    # Expected
    ...
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020    Verify Booking Status After Cut Off Time
    ...
    ...    ${today}
    ...    ${booking_id}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020    Verify Parcel Pickup Status After Cut Off Time
    ...
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020    Verify Homepage Title
    ...
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020    Verify Role Change In Profile
    ...
    # ...    ${DC_Operation_S020.receiving_cycle['company_name']}
    # ...    ${DC_Operation_S020.receiving_cycle['branch']}
    # ...    ${DC_Operation_S020.receiving_cycle['company_address']}
    # ...    ${DC_Operation_S020.receiving_cycle['sub_district']}
    # ...    ${DC_Operation_S020.receiving_cycle['district']}
    # ...    ${DC_Operation_S020.receiving_cycle['province']}
    # ...    ${DC_Operation_S020.receiving_cycle['postcode']}
    # ...    ${DC_Operation_S020.receiving_cycle['receiving_time']}
    # ...    ${DC_Operation_S020.receiving_cycle['receiving_type']}
    # ...    ${DC_Operation_S020.receiving_cycle['courier']}
    # ...    ${DC_Operation_S020.receiving_cycle['number_of_parcel']}
    # ...    ${DC_Operation_S020.receiving_cycle.status['waiting']}
    common.Verify Capture Screenshot    dc_operation    DC_Operation_S020    Verify Check Receiving Cycle Page
