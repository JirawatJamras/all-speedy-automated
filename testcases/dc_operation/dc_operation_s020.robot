...
DC_Operation_S020
    ...
    # Expected
    Sleep    2
    common.Verify Capture Screenshot    DC_Operation_S020    Verify Login Page
    ...
    common.Verify Capture Screenshot    DC_Operation_S020   Verify Home Page
    ...
    common.Verify Capture Screenshot    DC_Operation_S020   Verify Call Car Pick Up Page
    ...
    common.Verify Capture Screenshot    DC_Operation_S020   Verify Parcel Pickup Schedule Popup
...
Log    Step No.5 ระบุข้อมูล
    ...
    common.Verify Capture Screenshot    DC_Operation_S020   Verify Add Special Pickup Round Success

    Log    Step No.6 เลือกเมนู "จองการจัดส่งพัสดุ"
    b2c_home_page.Click Book Parcel Delivery    
    # Expected
    b2c_booking_delivery_page.Verify Booking Page For Business Customer
    common.Verify Capture Screenshot    DC_Operation_S020    Verify Booking Page
    ...
    common.Verify Capture Screenshot    DC_Operation_S020    Verify Term & Condition

    Log    Step No.8 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    # Expected   
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    DC_Operation_S020    Verify Select Parcel Type
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    DC_Operation_S020    Verify Create Parcel Page Sender Step
    ...
    common.Verify Capture Screenshot    DC_Operation_S020    Verify Booking Detail Page
    ...
    common.Verify Capture Screenshot    DC_Operation_S020    Verify Edit Booking Popup
    ...
    ...    ${today}
    ...    ${call_car_pick_up.default['price']}
    common.Verify Capture Screenshot    DC_Operation_S020    Verify Display Pickup Schedule Data
    ...
    common.Verify Capture Screenshot    DC_Operation_S020    Verify Complete Select Parcel Pickup Schedule And Save
    ...
    common.Verify Capture Screenshot    DC_Operation_S020    Verify Import File Popup
    ...
    common.Verify Capture Screenshot    DC_Operation_S020    Verify Import File Success
    ...
    ...    ${call_car_pick_up.text_parcel_id_start_with['chilled']}
    ...    ${DC_Operation_S020['parcel_number']}
    common.Verify Capture Screenshot    DC_Operation_S020    Verify Parcel Status After Cut Off Time
    b2c_home_page.Click Book Parcel Delivery    
    # Expected
    ...
    common.Verify Capture Screenshot    DC_Operation_S020    Verify Booking Status After Cut Off Time
    ...
    ...    ${today}
    ...    ${booking_id}
    common.Verify Capture Screenshot    DC_Operation_S020    Verify Parcel Pickup Status After Cut Off Time
    ...
    common.Verify Capture Screenshot    DC_Operation_S020    Verify Homepage Title
    ...
    common.Verify Capture Screenshot    DC_Operation_S020    Verify Role Change In Profile
    ...
    common.Verify Capture Screenshot    DC_Operation_S020    Verify Check Receiving Cycle Page
