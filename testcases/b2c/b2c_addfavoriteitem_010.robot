...
B2C_AddFavoriteItem_010_016
    ...
    [Tags]    B2C_AddFavoriteItem_010    UAT    Medium    Regression    In_Review1
    common.Open URL                           ${B2C_UAT_URL}
    register_general_customers_page.Select Business Customers Tab
    b2c_login_page.Input Email                    ${b2c_login_user_06['username']}
    b2c_login_page.Input Password                 ${b2c_login_user_06['password']}
    ...
    b2c_favorite_page.Verify Not Display Unsaved Senders In Favorite Page    ${b2c_AddFavoriteItem_010_016['sender_name']}
...
B2C_AddFavoriteItem_010_017
    ...
    b2c_favorite_page.Verify User Confirm To close Add Favorite Sender Popup
    common.Verify Capture Screenshot    B2C_AddFavoriteItem_010_017    Click Close X Button
