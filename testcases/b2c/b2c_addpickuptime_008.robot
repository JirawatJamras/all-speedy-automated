...
B2C_AddPickupTime_008_001
    ...
    ...                                         , กรณี กรอกชื่อรอบรถ
    ...                                         , "เลือกประเภทพัสดุ ไม่ถูกต้อง ไม่เลือกประเภทพัสดุ"
    ...                                         , "เลือกประเภทพัสดุ ไม่ถูกต้อง เลือกประเภทพัสดุเกิน 1 ตัวเลือก"
    ...                                         , "เลือกวันที่รถเข้ารับพัสดุ ถูกต้อง เลือกวันที่รถเข้ารับพัสดุ วันที่ข้างหน้า"
    ...                                         , "เลือกวันที่รถเข้ารับพัสดุ ถูกต้อง ไม่เลือกวันที่รถเข้ารับพัสดุ"
    ...                                         , "เลือกวันที่รถเข้ารับพัสดุ ไม่ถูกต้อง เลือกวันที่รถเข้ารับพัสดุ วันที่ย้อนหลัง"
    ...                                         , "เลือกช่วงเวลาที่ต้องการให้รถเข้ารับพัสดุ ถูกต้อง เลือกช่วงเวลาที่ต้องการให้รถเข้ารับพัสดุ 1 ตัวเลือก"
    ...                                         , "เลือกช่วงเวลาที่ต้องการให้รถเข้ารับพัสดุ ไม่ถูกต้อง ไม่เลือกช่วงเวลาที่ต้องการให้รถเข้ารับพัสดุ"
