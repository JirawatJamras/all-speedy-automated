...
SPS_Login_001_01
    ...
    sps_login_page.Verify Error Message You Need To Enter Login Name    SPS_Login_001_01
...
SPS_Login_001_02
    ...
    sps_login_page.Click Log On Button
    sps_login_page.Verify Error Message You Need To Enter Login Name    SPS_Login_001_02
...
SPS_Login_001_03
    ...
    [Tags]    SPS_Login_001    UAT    Low    Regression    Bix
    sps_landing_page.Click Login Button
    sps_login_page.Input Username    ${SPS_Login_001_03['username']}
    sps_login_page.Click Log On Button
    sps_login_page.Verify Error Message You Need To Enter A Password    SPS_Login_001_03
