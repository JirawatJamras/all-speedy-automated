...
Test Teardown     Run Keywords    Delete ID Number    ${Register_S002['id_number']}
                  ...    AND   Delete ID Number    ${Register_S004['id_number']}
                  ...    AND   Delete ID Number    ${Register_S005['id_number']}
                  ...    AND   Close Browser
