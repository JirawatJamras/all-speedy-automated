...
Register_S002_S004_S005_S008
    ...
    [Tags]    Register    RM_Lead_Assign_Multiple    UAT
...
Register_S002
    ...
    common.Verify Capture Screenshot     Register    Assign RM (Multiple tnx)    Pre Register 002 information 2
    ...
    common.Verify Capture Screenshot     Register    Assign RM (Multiple tnx)    Pre Register 002 Success
...
Register_S004
    ...
    common.Verify Capture Screenshot     Register    Assign RM (Multiple tnx)    Pre Register 004 fill information 

    Log    Step No.2 "กดปุ่มลงทะเบียน"
    register_business_pre_register.Click Confirm
    #Expected
    register_business_pre_register.Verify Confirm Page    ${Register.Pre_register['text_register_success']}
    common.Verify Capture Screenshot     Register    Assign RM (Multiple tnx)    Pre Register 004 Success
...
Register_S005
    ...
    common.Verify Capture Screenshot     Register    Assign RM (Multiple tnx)    Pre Register 005 fill information

    Log    Step No.2 "กดปุ่มลงทะเบียน"
    register_business_pre_register.Click Confirm
    register_business_pre_register.Verify Confirm Page       ${Register.Pre_register['text_register_success']}
    common.Verify Capture Screenshot     Register    Assign RM (Multiple tnx)    Pre Register 005 Success
...
Register_S008
    ...
    common.Verify Capture Screenshot     Register    Assign RM (Multiple tnx)    Select Checkbox
    pms_requests_page.Click Assign RM Button
    pms_requests_page.Verify Assign RM Popup
    common.Verify Capture Screenshot     Register    Assign RM (Multiple tnx)    Verify Assign RM Popup
    ...
    common.Verify Capture Screenshot     Register    Assign RM (Multiple tnx)    Verify Already Assign To RM Popup
    ...
    common.Verify Capture Screenshot     Register    Assign RM (Multiple tnx)    Assign RM 002
    ...
    ...    ${Register_S004['mobile_ext']}
    ...    ${Register_S008['rm_name']}
    common.Verify Capture Screenshot     Register    Assign RM (Multiple tnx)    Assign RM 004
    pms_requests_page.Verify Save Assign To RM Success [Individual]
    ...    ${Register_S005['checkbox_partner_types']}
    ...    ${Register_S005['first_name']}
    ...    ${Register_S005['last_name']}
    ...
    ...    ${Register_S005['mobile_ext']}
    ...    ${Register_S008['rm_name']}
    common.Verify Capture Screenshot     Register    Assign RM (Multiple tnx)    Assign RM 005