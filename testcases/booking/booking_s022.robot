...
Booking_S022
    ...
    [Tags]    Booking    Business_To_Customer    Regression    Defect043    Defect045    Defect047    Defect048    Defect050    Defect051    Defect052    Defect063    Defect072    
    ...    Defect075    Defect083    Defect102    Defect118    Defect126    Defect136    Defect258    Defect267    Defect278
    Log    Login
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    1.Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    2.Verify Term & Condition

    Log    Step No.3 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    # Expected
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    booking    Booking_S022    3.Verify Select Parcel Type
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S022    4.Verify Create Parcel Page Sender Step
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S022    5.Verify After Create Parcel Page Sender Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    6.Verify Draft Parcel Sender
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    7.Verify Data Sender
    ...
    # ...    ${EMPTY}
    # ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S022    8.Verify Data Receiver When Select Home
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S022    9.Verify After Create Parcel Page Receiver Step
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S022    10.Verify Parcel Detail
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    11.Verify Create Parcel Page After Input Parcel Detail Step

    Log    Step No.12 กดปุ่ม "บันทึกร่าง"
    b2c_booking_delivery_page.Click Save Button
    # Expected
    Log Defect No:  Defect102,Defect278
    b2c_booking_detail_page.Verify Booking Detail Page After Draft
    ...    ${Booking['text_booking_list']}
    ...    ${Booking['text_draft_status']}
    ...    ${Booking.text_blank['text_chilled_parcel_id_4_start_unit']}
    ...
    ...    ${Booking_S022['sender_address']}
    ...    ${Booking_S022['sender_postcode_full']}
    common.Verify Capture Screenshot    booking    Booking_S022    13.Verify Data Sender
    ...
    ...    ${Booking_S022['receiver_address']}
    ...    ${Booking_S022['receiver_postcode_full']}
    common.Verify Capture Screenshot    booking    Booking_S022    14.Verify Create Parcel Page Receiver Step When Select Home

    Log    Step No.15 กดปุ่ม "ถัดไป"
    b2c_booking_delivery_page.Click Next Button
    # Expected
    Log Defect No:  Defect083,Defect136
    b2c_booking_delivery_page.Verify Parcel Detail Page of Create Parcel [Chilled Parcel]
    ...    ${Booking.chilled_parcel['parcel_detail_S0']}
    ...    ${Booking.chilled_parcel['parcel_detail_S1']}
    ...    ${Booking.chilled_parcel['parcel_detail_S2']}
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    17.Verify Selected Coupon And Code
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    18.1.Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S022    18.2.Verify Booking Detail Page After Booking Success
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    19.Verify Created Booking On Booking Delivery Page
    ...
    ...    ${Booking.text_blank['origin_shipping']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S022    20.1.Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S022    20.2.Verify Booking Detail Page
    ...
    ${booking_time}    Get Booking Time
    # Expected
    Log Defect No:  Defect075,Defect102,Defect126,Defect258
    b2c_booking_detail_page.Verify Booking Detail Page
    ...    ${Booking['text_title_booking_list']}
    ...    ${booking_id}
    ...    ${Booking['text_chilled_parcel_id_4_start_unit']}
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S022    22.1.Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S022    22.2.Verify Booking Detail Page After Set Origin Shipping

    Log    Step No.23 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Parcel Label
    # Expected
    Log Defect No:  Defect118,Defect267
    ...
    ...    ${Booking_S022['parcel_detail_remark']}
    common.Verify Capture Screenshot    booking    Booking_S022    23.Verify Parcel Label
