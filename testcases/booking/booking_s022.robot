...
Booking_S022
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Term & Condition

    Step Test:    Step No.3 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    # Expected   
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Select Parcel Type
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Create Parcel Page Sender Step
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S022    Verify After Create Parcel Page Sender Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Draft Parcel Sender
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Data Sender
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Data Receiver When Select Home
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S022    Verify After Create Parcel Page Receiver Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Create Parcel Page After Input Parcel Detail Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Draft Parcel After Input Parcel Detail
    ...
    ...    ${Booking_S022['receiver_address']}
    ...    ${Booking_S022['receiver_postcode_full']}
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Create Parcel Page Receiver Step When Select Home
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Promotion
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Selected Coupon And Code
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Booking Detail Page After Booking Success
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Created Booking On Booking Delivery Page
    ...
    # ...    ${Booking.text_blank['origin_shipping']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Booking Detail Page
    ...
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Edit Booking List Popup  
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Booking Detail Page After Set Origin Shipping
    ...
    # ...    ${Booking_S022['parcel_detail_remark']}
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Parcel Label

    Step Test:    Step No.24 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ" ใน PopUp "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S022    Verify Print Screen