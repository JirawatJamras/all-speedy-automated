...
Booking_S021
    ...
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Term & Condition

    Step Test:    Step No.3 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    # Expected   
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Select Parcel Type
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Create Parcel Page Sender Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Input Data Sender
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Create Parcel Page Receiver Step When Select Home

    Step Test:    Step No.7 กดปุ่ม ขั้นตอนข้อมูลผู้รับพัสดุ
    ...
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Favorites Receiver PopUp
    ...
    ...    ${Booking_S021['receiver_address']}
    ...    ${Booking_S021['receiver_postcode_full']}
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Choose Receiver From Favorites
    ...
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Draft Parcel Receiver
    ...
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Data Sender
    ...
    # ...    ${EMPTY}
    # ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Parcel Detail

    Step Test:    Step No.13 "ขั้นตอนรายละเอียดพัสดุ"
    b2c_booking_delivery_page.Select Parcel Size    ${Booking_S021['parcel_size']}
    # Defect118
    # Input COD : Expected Result is b2c_booking_delivery_page.Input COD    ${Booking_S021['parcel_cod']}
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Select Parcel Size And Input COD
    ...
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Promotion
    ...
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Booking Detail Page After Booking Success
    ...
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Created Booking On Booking Delivery Page
    ...
    # ...    ${Booking.text_blank['store_code']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Booking Detail Page
    ...
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Edit Booking List Popup  
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Booking Detail Page After Set Origin Shipping
    ...
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Parcel Label

    Step Test:    Step No.21 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ" ใน PopUp "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S021    Verify Print Screen