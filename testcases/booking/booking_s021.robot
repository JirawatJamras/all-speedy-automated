...
Booking_S021
    ...
    common.Verify Capture Screenshot    Booking_S021    Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    Booking_S021    Verify Term & Condition

    Log    Step No.3 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    #Expected   
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    Booking_S021    Verify Select Parcel Type
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    Booking_S021    Verify Create Parcel Page Sender Step
    ...
    common.Verify Capture Screenshot    Booking_S021    Verify Data Sender
    ...
    # common.Verify Capture Screenshot    Booking_S021    Verify Parcel Detail Page of Create Parcel [Dry Parcel]
    ...
    common.Verify Capture Screenshot    Booking_S021    Verify Promotion
    ...
    common.Verify Capture Screenshot    Booking_S021    Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S021    Verify Booking Detail Page After Booking Success
    ...
    ...    ${Booking_S021['booking_price']}
    common.Verify Capture Screenshot    Booking_S021    Verify Created Booking On Booking Delivery Page
    ...
    ...    ${Booking.text_default['total_price_value']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    Booking_S021    Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S021    Verify Booking Detail Page
    ...
    common.Verify Capture Screenshot    Booking_S021    Verify Edit Booking List Popup  
    ...
    # b2c_booking_detail_page.Search Shipping Store    ${Booking_S021['store_code']}
    ...
    # ...    ${Booking_S021['store_code']}
    # common.Scroll Window To Vertical    500
    # common.Verify Capture Screenshot    Booking_S021    Verify Booking Summary After Set Origin Shipping
    # common.Scroll Window To Vertical    0
    # common.Verify Capture Screenshot    Booking_S021    Verify Booking Detail Page After Set Origin Shipping
    ...
    common.Verify Capture Screenshot    Booking_S021    Verify Parcel Label

    Log    Step No.21 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ" ใน PopUp "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    Booking_S021    Verify Print Screen
