...
Booking_S020
    ...
    common.Verify Capture Screenshot    Booking_S020    Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    Booking_S020    Verify Term & Condition

    Log    Step No.3 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    #Expected   
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    Booking_S020    Verify Select Parcel Type
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    Booking_S020    Verify Create Parcel Page Sender Step
    ...
    #Expected
    common.Verify Capture Screenshot    Booking_S020    Verify Create Parcel Page After Input Sender Step
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    Booking_S020    Verify Create Parcel Page Receiver Step When Select Home
    ...
    #Expected
    common.Verify Capture Screenshot    Booking_S020    Verify After Create Parcel Page Receiver Step
    ...
    common.Verify Capture Screenshot    Booking_S020    Verify Draft Parcel Receiver
    ...
    common.Verify Capture Screenshot    Booking_S020    Verify Data Sender
    ...
    common.Verify Capture Screenshot    Booking_S020    Verify Parcel Detail
    ...
    common.Verify Capture Screenshot    Booking_S020    Verify Create Parcel Page After Input Parcel Detail Step 
    ...
    common.Verify Capture Screenshot    Booking_S020    Verify Booking Detail Page After Booking Success
    ...
    common.Verify Capture Screenshot    Booking_S020    Verify Created Booking On Booking Delivery Page
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S020    Verify Booking Detail Page 
    ...
    common.Verify Capture Screenshot    Booking_S020    Verify Edit Booking List Popup  
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S020    Verify Booking Detail Page After Set Origin Shipping
