...
Booking_S017
    ...
    common.Verify Capture Screenshot    Booking_S017    Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    Booking_S017    Verify Select Parcel Type
    ...
    common.Verify Capture Screenshot    Booking_S017    Verify Click Choose Favorites
    ...
    common.Verify Capture Screenshot    Booking_S017    Verify After Create Parcel Page Sender Step
   ...
   Log    Step No.7 กดปุ่ม "ถัดไป"
    ...
    common.Verify Capture Screenshot    Booking_S017    Verify Favorites Receiver PopUp
    ...
    common.Verify Capture Screenshot    Booking_S017    Verify Choose Receiver From Favorites
    ...
    common.Verify Capture Screenshot    Booking_S017    Verify Draft Parcel Receiver
    ...
    ...    ${Booking_S017['sender_address']}
    ...    ${Booking_S017['sender_postcode_full']}
    common.Verify Capture Screenshot    Booking_S017    Verify Data Sender
    ...
    ...    ${Booking_S017['receiver_name']}
    ...    ${Booking_S017['receiver_store_full']}
    common.Verify Capture Screenshot    Booking_S017    Verify Data Receiver When Select 7-ELEVEN Store
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    Booking_S017    Verify Parcel Detail
    ...
    # Expected
    common.Verify Capture Screenshot    Booking_S017    Verify Create Parcel Page After Input Parcel Detail Step
    ...
    common.Verify Capture Screenshot    Booking_S017    Verify Promotion
    ...
    # common.Verify Capture Screenshot    Booking_S017    Verify Selected Coupon And Code
    ...
    common.Verify Capture Screenshot    Booking_S017    Verify Booking Detail Page After Booking Success
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S017    Verify Booking Detail Page 
    ...
    common.Verify Capture Screenshot    Booking_S017    Verify Edit Booking List Popup
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S017    Verify Booking Detail Page After Set Origin Shipping
    ...
    # Expected
    common.Verify Capture Screenshot    Booking_S017    Verify Print Screen