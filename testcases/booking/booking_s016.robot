...
Booking_S016
    ...
    common.Verify Capture Screenshot    Booking_S016    Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    Booking_S016    Verify Term & Condition

    Log    Step No.3 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    #Expected   
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    Booking_S016    Verify Select Parcel Type
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    Booking_S016    Verify Create Parcel Page Sender Step
    ...
    common.Verify Capture Screenshot    Booking_S016    Verify Click Choose Favorites
    ...
    common.Verify Capture Screenshot    Booking_S016    Verify After Create Parcel Page Sender Step
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    Booking_S016    Verify Create Parcel Page Receiver Step When Select Home
    ...
    common.Verify Capture Screenshot    Booking_S016    Verify Select Parcel Size And Input Remark
    ...
    common.Verify Capture Screenshot    Booking_S016    Verify Draft Parcel  
    ...
    ...    ${Booking_S016['sender_address']}
    ...    ${Booking_S016['sender_postcode_full']}
    common.Verify Capture Screenshot    Booking_S016    Verify Data Sender
    ...
    common.Verify Capture Screenshot    Booking_S016    Verify Booking Detail Page After Booking Success
    ...
    ...    0.00บาท    # Expected Result is ${Booking_S016['booking_price']}
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S016    Verify Booking Detail Page
    ...
    common.Verify Capture Screenshot    Booking_S016    Verify Edit Booking List Popup  
    ...
    ...    ${Booking_S016['total_price_amount']}
    ...    ${Booking_S016['total_price_value']}
    ...    ${Booking_S016['store_code']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    Booking_S016    Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S016    Verify Booking Detail Page After Set Origin Shipping
    ...
    ...    ${Booking_S016['receiver_postcode_5_digits']}
    ...
    common.Verify Capture Screenshot    Booking_S016    Verify Parcel Label

    Log    Step No.22 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    Booking_S016    Verify Print Screen
