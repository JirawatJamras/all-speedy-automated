...
Booking_S011
    ...
    common.Verify Capture Screenshot    booking    Booking_S011    Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    booking    Booking_S011    Verify Term & Condition

    Step Test:    Step No.3 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    # Expected   
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    booking    Booking_S011    Verify Select Parcel Type
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S011    Verify Create Parcel Page Sender Step
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S011    Verify After Create Parcel Page Sender Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S011    Verify Data Sender
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S011    Verify Create Parcel Page Receiver Step When Select Home
    ...
    common.Verify Capture Screenshot    booking    Booking_S011    Verify After Create Parcel Page Receiver Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S011    Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S011    Verify Booking Detail Page After Booking Success
    ...
    common.Verify Capture Screenshot    booking    Booking_S011    Verify Created Booking On Booking Delivery Page
    ...
    # ...    ${Booking.text_blank['store_code']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S011    Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S011    Verify Booking Detail Page 
    ...
    common.Verify Capture Screenshot    booking    Booking_S011    Verify Edit Booking List Popup  
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S011    Verify Print Screen