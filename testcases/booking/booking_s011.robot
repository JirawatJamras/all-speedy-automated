...
Booking_S011
    ...
    common.Verify Capture Screenshot    Booking_S011    Verify Booking Page
    ...
    common.Verify Capture Screenshot    Booking_S011    Verify Draft Parcel Sender
    ...
    common.Verify Capture Screenshot    Booking_S011    Verify Create Parcel Page Receiver Step
