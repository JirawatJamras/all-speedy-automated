...
Booking_S042
    ...
    ...    ${Booking_S003['store_code']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    Booking_S042    Verify Booking Summary After Edit Data Receiver
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S042    Verify Booking Detail Page After Edit Data Receiver
    ...
    ...    ${Booking_S042['receiver_address']}
    ...    ${Booking_S042['receiver_postcode_full']}
    common.Verify Capture Screenshot    Booking_S042    Verify Data Receiver After Edit Sender Data
    ...
    common.Verify Capture Screenshot    Booking_S042    Verify Parcel Detail
    ...
    # Expected
    common.Verify Capture Screenshot    Booking_S042    Verify Edit Data Parcel
    ...
    common.Verify Capture Screenshot    Booking_S042    Verify Parcel Detail After Edit Sender Data
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S042    Verify Booking Detail Page After Coupon And Code
    ...
    ...    ${Booking_S042['parcel_detail_remark']}
    common.Verify Capture Screenshot    Booking_S042    Verify Parcel Label
    
    Log    Step No.20 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ" ใน PopUp "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    Booking_S042    Verify Print Screen