...
Booking_S043
    ...
    common.Verify Capture Screenshot    Booking_S043    Verify Created Booking On Booking Delivery Page
    ...
    common.Verify Capture Screenshot    Booking_S043    Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S043    Verify Booking Detail Page
    ...
    common.Verify Capture Screenshot    Booking_S043    Verify Data Sender
    ...
    ...    ${Booking_S020['sender_address']}
    ...    ${Booking_S020['sender_postcode_full']}
    common.Verify Capture Screenshot    Booking_S043    Verify Can Edit Data Sender
    ...
    # Expected
    common.Verify Capture Screenshot    Booking_S043    Verify Edit Data Sender
    ...
    ...    ${Booking.origin_shipping['idc_company_address']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    Booking_S043    Verify Booking Summary After Edit Sender Data
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S043    Verify Booking Detail Page After Edit Sender Data
    ...
    common.Verify Capture Screenshot    Booking_S043    Verify Data Sender After Edit Sender Data
    ...
    ...    ${Booking_S020['receiver_address']}
    ...    ${Booking_S020['receiver_postcode_full']}
    common.Verify Capture Screenshot    Booking_S043    Verify Data Receiver
    ...
    ...    ${Booking_S020['receiver_address']}
    ...    ${Booking_S020['receiver_postcode_full']}
    common.Verify Capture Screenshot    Booking_S043    Verify Can Edit Data Receiver
    ...
    common.Verify Capture Screenshot    Booking_S043    Verify Edit Data Receiver
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S043    Verify Booking Detail Page After Edit Data Receiver
    ...
    ...    ${Booking_S043['sender_address']}
    ...    ${Booking_S043['sender_postcode_full']}
    common.Verify Capture Screenshot    Booking_S043    Verify Data Sender After Edit Receiver Data
    ...
    common.Verify Capture Screenshot    Booking_S043    Verify Data Receiver After Edit Receiver Data
    ...
    common.Verify Capture Screenshot    Booking_S043    Verify Parcel Detail
    ...
    ...    ${EMPTY}
    ...    ${Booking_S020['parcel_detail_remark']}
    common.Verify Capture Screenshot    Booking_S043    Verify Can Edit Parcel Detail
    ...
    # Expected
    common.Verify Capture Screenshot    Booking_S043    Verify Edit Data Parcel Detail
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S042    Verify Booking Detail Page After Edit Data Parcel
    ...
    ...    ${Booking_S043['sender_address']}
    ...    ${Booking_S043['sender_postcode_full']}
    common.Verify Capture Screenshot    Booking_S043    Verify Data Sender After Edit Data Parcel
    ...
    ...    ${Booking_S043['receiver_address']}
    ...    ${Booking_S043['receiver_postcode_full']}
    common.Verify Capture Screenshot    Booking_S043    Verify Data Receiver After Edit Data Parcel
    ...
    common.Verify Capture Screenshot    Booking_S043    Verify Parcel Detail After Edit Data Parcel
    ...
    common.Verify Capture Screenshot    Booking_S042    Verify Take Out Coupon
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S042    Verify Booking Detail Page After Edit Coupon And Code
    ...
    ...    ${Booking_S043['parcel_detail_remark']}
    common.Verify Capture Screenshot    Booking_S043    Verify Parcel Label

    Log    Step No.26 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ" ใน PopUp "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    Booking_S043    Verify Print Screen