...
Booking_S014
    ...
    [Tags]    Booking    Business_To_Customer    Regression    Unknown    Defect043    Defect045    Defect047    Defect048    Defect051    Defect052    Defect055    Defect063    
    ...
    b2c_booking_delivery_page.Input And Select Store Code Receiver    ${Booking_S014['receiver_store_code_5_digits']}    ${Booking_S014['receiver_store_address']}
    ...
    # Expected
    Log Defect No:  Defect051,Defect052,Defect076
    ...
    ${booking_time}    Get Booking Time
    # Expected
    Log Defect No:  Defect048,Defect051,Defect063,Defect076,Defect258
    ...
    common.Verify Capture Screenshot    booking    Booking_S014    14.1.Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S014    14.2.Verify Booking Detail Page After Booking Success
    ...
    ...    ${Booking.text_blank['origin_shipping']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S014    16.1.Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S014    16.2.Verify Booking Detail Page
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S014    18.1.Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S014    18.2.Verify Booking Detail Page After Set Origin Shipping
