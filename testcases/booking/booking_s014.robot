...
Booking_S014
    ...
    common.Verify Capture Screenshot    Booking_S014    Verify Create Parcel Page Sender Step

    Log    Step No.5 ขั้นตอนข้อมูลผู้ส่งพัสดุ
    b2c_booking_delivery_page.Input Phone Sender    ${Booking_S014['sender_phone']}
    b2c_booking_delivery_page.Input Name Sender    ${Booking_S014['sender_name']}    
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    Booking_S014    Verify Create Parcel Page Receiver Step When Select Home

    Log    Step No.7 ขั้นตอนข้อมูลผู้รับพัสดุ
    b2c_booking_delivery_page.Input Phone Receiver    ${Booking_S014['receiver_phone']}
    b2c_booking_delivery_page.Input Name Receiver    ${Booking_S014['receiver_name']}
    b2c_booking_delivery_page.Click Button    ${tab_send_to_store}
    b2c_booking_delivery_page.Input Store Code Receiver    ${Booking_S014['receiver_store_code_5_digits']}
   ...
   Log    Step No.8 กดปุ่ม "บันทึกร่าง"
    ...
    ...    ${Booking_S014['sender_phone']}
    ...    ${Booking.img_is_favorite['img_receiver_heart']}
    ...    ${Booking_S014['receiver_name']}
    ...    ${Booking_S014['receiver_phone']}
    ...    01523 ปากน้ำหลังสวน ปากน้ำ หลังสวน ชุมพร 86150    # Expected is ${Booking_S014['receiver_store_address']}
    ...    ${EMPTY}         # Expected Result is ${Booking.text_blank['parcel_size']}
    ...    ${Booking.text_blank['price_value']}
    ...    ${Booking.text_blank['buy_insurance']}
    ...    ${Booking.text_blank['cod_value']}
    common.Verify Capture Screenshot    Booking_S014    Verify Draft Parcel
    ...
    common.Verify Capture Screenshot    Booking_S014    Verify Data Sender
    ...
    common.Verify Capture Screenshot    Booking_S014    Verify Parcel Detail
   ...
   Log    Step No.14 ขั้นตอน Promotion
    ...
    ...    ${Booking_S014['receiver_phone']}
    ...    01523 ปากน้ำหลังสวน ปากน้ำ หลังสวน ชุมพร 86150    # Expected is ${Booking_S014['receiver_store_address']}
    ...    ${Booking_S014['parcel_size']}
    ...    ${Booking.text_blank['price_value']}
    ...    ${Booking_S014['buy_insurance_verify']}
    ...    ${Booking.text_blank['cod_value']}
    ...
    common.Verify Capture Screenshot    Booking_S014    Verify Booking Detail Page After Booking Success
    ...
    ...    ${Booking_S014['booking_price']}
    common.Verify Capture Screenshot    Booking_S014    Verify Created Booking On Booking Delivery Page
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S014    Verify Booking Detail Page
    ...
    common.Verify Capture Screenshot    Booking_S014    Verify Edit Booking List Popup  
    ...
    ...    01523 ปากน้ำหลังสวน ปากน้ำ หลังสวน ชุมพร 86150    # Expected is ${Booking_S014['receiver_store_address']}
    ...    ${Booking_S014['parcel_size']}
    ...    ${Booking_S014['price_value']}
    ...    ${Booking_S014['buy_insurance_verify']}
    ...    ${Booking.text_blank['cod_value']}
    ...    ${Booking['text_title_booking_summary']}
    ...    ${Booking.text_default['discount_amount']}
    ...    ${Booking.text_default['discount_value']}
    ...    ${Booking_S014['insurance_fee_amount']}
    ...    ${Booking_S014['insurance_fee_value']}
    ...    ${Booking.text_default['cod_fee_amount']}
    ...    ${Booking.text_default['cod_fee_value']}
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S014    Verify Booking Detail Page After Set Origin Shipping
   ...
   Log    Step No.19 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ"
    ...
    ...    ${Booking_S014['receiver_store_code_5_digits']}
    ...    ${Booking_S014['parcel_package_type']}
    ...    ${Booking_S014['parcel_size']}
    ...    ${Booking_S014['sender_name']}
    ...    ${Booking_S014['sender_phone']}
    ...    ${Booking_S014['sender_address']}
    ...
    ...    ${Booking_S014['receiver_name']}
    ...    ${Booking_S014['receiver_phone']}
    ...    01523 7-11 ปากน้ำหลังสวน ปากน้ำ หลังสวน ชุมพร 86150    #${Booking_S014['receiver_store_address']}
    ...    ${Booking.label['parcel_cod']}
    ...    ${Booking.label['parcel_buy_insure']}
    ...    ${Booking.text_blank['parcel_detail_remark']}
    common.Verify Capture Screenshot    Booking_S014    Verify Parcel Label

    Log    Step No.20 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ" ใน PopUp "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    Booking_S014    Verify Print Screen