...
Booking_S023
    ...
    common.Verify Capture Screenshot    Booking_S023    Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    Booking_S023    Verify Term & Condition

    Log    Step No.3 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    #Expected   
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    Booking_S023    Verify Select Parcel Type
    ...
    common.Verify Capture Screenshot    Booking_S023    Verify Click Choose Favorites
    ...
    common.Verify Capture Screenshot    Booking_S023    Verify After Create Parcel Page Sender Step
    ...
    common.Verify Capture Screenshot    Booking_S023    Verify Draft Parcel
    ...
    ...    ${Booking_S023['sender_address']}
    ...    ${Booking_S023['sender_postcode_full']}
    common.Verify Capture Screenshot    Booking_S023    Verify Data Sender
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    Booking_S023    Verify Create Parcel Page Receiver Step When Select Home
    ...
    #Expected
    common.Verify Capture Screenshot    Booking_S023    Verify After Input Receiver Data
    ...
    common.Verify Capture Screenshot    Booking_S023    Verify Parcel Detail

    Log    Step No.12 ขั้นตอนรายละเอียดพัสดุ
    b2c_booking_delivery_page.Select Parcel Size    ${Booking_S023['parcel_size']}
    common.Verify Capture Screenshot    Booking_S023    Verify Create Parcel Page After Input Parcel Detail Step 
    ...
    ...    ${Booking.text_default['total_price_amount']}    #${Booking_S023['total_price_amount']}
    ...    ${Booking.text_default['total_price_value']}    # Expected result is ${Booking_S023['total_price_value1']}
    ...    ${EMPTY}    #${Booking.text_blank['store_code']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    Booking_S023    Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S023    Verify Booking Detail Page After Booking Success
    ...
    common.Verify Capture Screenshot    Booking_S023    Verify Created Booking On Booking Delivery Page
    ...
    ...    ${Booking.text_default['cod_fee_amount']}
    ...    ${Booking.text_default['cod_fee_value']}
    ...    ${Booking.text_default['total_price_amount']}    # Expected Result is ${Booking_S023['total_price_amount']}
    ...    ${Booking.text_default['total_price_value']}    # Expected result is ${Booking_S023['total_price_value1']}
    ...    ${EMPTY}    #${Booking.text_blank['store_code']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    Booking_S023    Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S023    Verify Booking Detail Page
    ...
    ...    ${Booking_S023['origin_shipping']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    Booking_S023    Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S023    Verify Booking Detail Page After Set Origin Shipping
    ...
    common.Verify Capture Screenshot    Booking_S023    Verify Parcel Label

    Log    Step No.20 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ" ใน PopUp "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    Booking_S023    Verify Print Screen