...
Booking_S008
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Term & Condition

    Step Test:    Step No.3 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    # Expected   
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Select Parcel Type

    Step Test:    Step No.4 กดปุ่ม "พัสดุทั่วไป"
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Create Parcel Page Sender Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Click Choose Favorites
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    Verify After Create Parcel Page Sender Step

    Step Test:    Step No.7 กดปุ่ม "ถัดไป"
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Create Parcel Page Receiver Step When Select Home

    Step Test:    Step No.8 ขั้นตอนข้อมูลผู้รับพัสดุ
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S008    Verify After Create Parcel Page Receiver Step
    ...
    Step Test:    Step No.10 ขั้นตอนรายละเอียดพัสดุ
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Select Parcel Size And Input Remark

    Step Test:    Step No.11 กดปุ่ม "บันทึกร่าง"
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Draft Parcel After Input Parcel Detail

    Step Test:    Step No.12 กดที่รายการพัสดุที่มีสถานะ "ร่าง"
    ...
    ...    ${Booking_S008['sender_address']}
    ...    ${Booking_S008['sender_postcode_full']}
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Data Sender
    ...
    ...    ${Booking_S008['receiver_address']}
    ...    ${Booking_S008['receiver_postcode_full']}
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Data Receiver When Select Home
    ...
    ...    ${Booking['parcel_detail_remark']}
    b2c_booking_delivery_page.Verify Textbox Value On Parcel Detail Step [Dry Parcel]
    ...    ${Booking_S008['parcel_insure_verify2']}
    ...    ${Booking_S008['parcel_cod_verify2']}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Parcel Detail Page of Create Parcel [Dry Parcel] 
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Promotion

    Step Test:    Step No.16 ขั้นตอน Promotion
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Booking Detail Page After Booking Success

    Step Test:    Step No.17 กดเมนู "จองการจัดส่งพัสดุ"
    b2c_home_page.Click Book Parcel Delivery
    b2c_booking_detail_page.Wait Until Loading Icon Success
    # Defect047
    # Expected
    ...
    # ...    ${booking_time}
    # ...    ${Booking['text_parcel_status_select_shipping_origin']}
    # ...    ${Booking_S008['booking_name']}
    # ...    ${Booking_S008['booking_item']}
    # ...    ${Booking_S008['booking_price']}
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Created Booking On Booking Delivery Page

    Step Test:    Step No.18 กดรายการบุ๊คกิ้งที่มีสถานะ "เลือกต้นทางจัดส่ง"
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Booking Detail Page
    
    Step Test:    Step No.19 กดปุ่ม "แก้ไขรายการบุ๊คกิ้ง"
    b2c_booking_detail_page.Click Edit Booking List
    # Expected
    b2c_booking_detail_page.Verify Edit Booking List Popup    
    ...    ${Booking_S008['parcel_type']}
    ...    ${Booking_S008['booking_name']}
    ...    ${Booking['text_shipping_origin_aria']}
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Edit Booking List Popup  

    Step Test:    Step No.20 "กรอกข้อมูลเพื้นที่ต้นทางการจัดส่ง"
    b2c_booking_detail_page.Select Shipping Origin Tab    ${Booking_S008['shipping_origin']}
    b2c_booking_detail_page.Search Shipping Store    ${Booking_S008['store_code']}
    ...
    # ...    ${Booking_S008['receiver_postcode_full']}
    # ...    ${Booking_S008['parcel_size']}
    # ...    ${Booking_S008['parcel_price_verify']}
    # ...    ${Booking_S008['parcel_insure_verify']}
    # ...    ${Booking_S008['parcel_cod_verify']}
    # ...    ${Booking['text_title_booking_summary']}
    # ...    ${Booking.text_default['discount_amount']}
    ...
    # ...    ${Booking.origin_shipping['15888_store_address']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Booking Detail Page After Set Origin Shipping

    Step Test:    Step No.21 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ"
    ...
    ...    ${Booking_S008['receiver_postcode_5_digits']}
    ...    ${Booking_S008['parcel_package_type']}
    ...    ${Booking_S008['parcel_size']}
    ...    ${Booking_S008['sender_name']}
    ...    ${Booking_S008['sender_phone']}
    ...    ${Booking_S008['sender_address']}
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Parcel Label

    Step Test:    Step No.22 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S008    Verify Print Screen
