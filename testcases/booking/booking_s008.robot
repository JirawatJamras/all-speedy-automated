...
Booking_S008
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    16.Verify Booking Detail Page After Booking Success
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S008    18.Verify Booking Detail Page
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S008    20.Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S008    20.Verify Booking Detail Page After Set Origin Shipping
