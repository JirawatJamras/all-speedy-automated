...
Booking_S008
    ...
    [Tags]    Booking    Business_To_Customer    UAT    Unknown    Defect043    Defect045    Defect047    Defect048    Defect053    Defect055    Defect063    Defect078    Defect258    Defect267
    Log    Login
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    1.Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    2.Verify Term & Condition

    Log    Step No.3 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    # Expected   
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    booking    Booking_S008    3.Verify Select Parcel Type
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S008    4.Verify Create Parcel Page Sender Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    5.Verify Click Choose Favorites
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    6.Verify After Create Parcel Page Sender Step
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S008    7.Verify Create Parcel Page Receiver Step When Select Home
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S008    8.Verify After Create Parcel Page Receiver Step
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S008    9.Verify Parcel Detail
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S008    10.Verify Select Parcel Size And Input Remark

    Log    Step No.11 กดปุ่ม "บันทึกร่าง"
    b2c_booking_delivery_page.Click Save Button
    # Expected
    Log Defect No:  Defect053
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    11.Verify Draft Parcel After Input Parcel Detail
    ...
    ...    ${Booking_S008['sender_address']}
    ...    ${Booking_S008['sender_postcode_full']}
    common.Verify Capture Screenshot    booking    Booking_S008    12.Verify Data Sender
    ...
    ...    ${Booking_S008['receiver_address']}
    ...    ${Booking_S008['receiver_postcode_full']}
    common.Verify Capture Screenshot    booking    Booking_S008    13.Verify Data Receiver When Select Home
    ...
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S008    14.Verify Parcel Detail Page of Create Parcel [Dry Parcel] 
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    15.Verify Promotion
    ...
    ${booking_time}    Get Booking Time
    # Expected
    Log Defect No:  Defect048,Defect053,Defect063,Defect258
    ...
    ...    ${Booking_S008['total_price_value1']}
    ...    ${Booking.text_blank['origin_shipping']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S008    16.1.Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S008    16.2.Verify Booking Detail Page After Booking Success
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    17.Verify Created Booking On Booking Delivery Page
    ...
    ...    ${Booking.text_blank['origin_shipping']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S008    18.1.Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S008    18.2.Verify Booking Detail Page
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    19.Verify Edit Booking List Popup  
    ...
    ${booking_time}    Get Booking Time
    # Expected
    Log Defect No:  Defect053,Defect078,Defect258
    b2c_booking_detail_page.Verify Booking Detail Page
    ...    ${Booking['text_title_booking_list']}
    ...    ${booking_id}
    ...    ${Booking['text_dry_parcel_id_4_start_unit']}
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S008    20.1.Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S008    20.2.Verify Booking Detail Page After Set Origin Shipping
    ...
    common.Verify Capture Screenshot    booking    Booking_S008    21.Verify Parcel Label

    Log    Step No.22 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S008    22.Verify Print Screen