...
Booking_S026
    ...
    common.Verify Capture Screenshot    Booking_S026    Verify Booking Page
    ...
    common.Verify Capture Screenshot    Booking_S026    Verify Draft Parcel Sender
    ...
    ...    ${Booking_S026['receiver_postcode_5_digits']}
