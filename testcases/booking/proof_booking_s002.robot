...
Booking_S002
    ...
    [Tags]    Booking    Business_To_Customer    UAT    Unknown    Defect042    Defect043    Defect045    Defect047    Defect048    Defect052    Defect055    Defect056    Defect063    Defect078    Defect101    Defect258    Defect261
    Log    Login
    ...
    common.Verify Capture Screenshot    booking    Booking_S002    1.Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    booking    Booking_S002    2.Verify Term & Condition

    Log    Step No.3 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    # Expected   
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    booking    Booking_S002    3.Verify Select Parcel Type
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S002    4.Verify Create Parcel Page Sender Step
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S002    5.Verify Create Parcel Page After Input Sender Step
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S002    6.Verify Create Parcel Page Receiver Step When Select Home
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S002    7.Verify Create Parcel Page After Input Receiver Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S002    8.Verify Draft Parcel Receiver
    ...
    common.Verify Capture Screenshot    booking    Booking_S002    9.Verify Data Sender
    ...
    ...    ${Booking_S002['receiver_address']}
    ...    ${Booking_S002['receiver_postcode_full']}
    common.Verify Capture Screenshot    booking    Booking_S002    10.Verify Data Receiver When Select Home
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S002    11.Verify Parcel Detail

    Log    Step No.12 ขั้นตอนรายละเอียดพัสดุ
    b2c_booking_delivery_page.Select Parcel Size    ${Booking_S002['parcel_size']}
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S002    12.Verify Create Parcel Page After Input Parcel Detail Step 
    ...
    common.Verify Capture Screenshot    booking    Booking_S002    13.Verify Promotion
    ...
    ...    รายการบุ๊กกิ๊ง ${booking_id}  #${Booking_S002['booking_name']}
    ...    ${booking_time}
    ...
    ...    0.00  #${Booking_S002['total_price_value1']}
    ...      #${Booking.text_blank['origin_shipping']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S002    14.Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S002    14.Verify Booking Detail Page After Booking Success
    ...
    ...    0.00 บาท  #${Booking.text_default['booking_price']}
    common.Verify Capture Screenshot    booking    Booking_S002    15.Verify Created Booking On Booking Delivery Page
    ...
    ...      #${Booking.text_blank['origin_shipping']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S002    16.Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S002    16.Verify Booking Detail Page
    ...
    common.Verify Capture Screenshot    booking    Booking_S002    17.Verify Edit Booking List Popup  
    ...
    ...    15888 7-11 สาขาCP TOWER สีลม สีลม บางรัก กรุงเทพมหานคร 10500  #${Booking.origin_shipping['15888_store_address']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S002    18.Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S002    18.Verify Booking Detail Page After Set Origin Shipping
    ...
    common.Verify Capture Screenshot    booking    Booking_S002    19.Verify Parcel Label

    Log    Step No.20 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ" ใน PopUp "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S002    20.Verify Print Screen