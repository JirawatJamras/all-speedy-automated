...
Booking_S024
    ...
    common.Verify Capture Screenshot    Booking_S024    Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    Booking_S024    Verify Data Sender
    ...
    ...    01523 ปากน้ำหลังสวน ปากน้ำ หลังสวน ชุมพร 86150    # Expected is ${Booking_S024['receiver_store_address']}
    ...    ${EMPTY}         # Expected Result is ${Booking.text_blank['parcel_size']}
    ...    ${Booking.text_blank['price_value']}
    ...    ${Booking.text_blank['buy_insurance']}
    ...    ${Booking.text_blank['cod_value']}
    ...
    common.Verify Capture Screenshot    Booking_S024    Verify Data Receiver When Select 7-ELEVEN Store
    ...
    ...    0    #${Booking_S024['total_price_amount']}
    ...    0.00    #${Booking_S024['total_price_value1']}
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    Booking_S024    Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S024    Verify Booking Detail Page After Set Origin Shipping
    ...
    ...    ${Booking_S024['receiver_name']}
    ...    ${Booking_S024['receiver_phone']}
    ...    01523 7-11 ปากน้ำหลังสวน ปากน้ำ หลังสวน ชุมพร 86150    #${Booking_S024['receiver_store_address']}
