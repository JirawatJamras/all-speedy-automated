...
Booking_S024
    ...
    b2c_booking_delivery_page.Input Store Code Receiver    ${Booking_S024['receiver_store_code_5_digits']}
    b2c_booking_delivery_page.Click Store Receiver Lists    ${Booking_S024['receiver_store_address']}
