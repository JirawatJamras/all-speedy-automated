...
Booking_S025
    ...
    common.Verify Capture Screenshot    Booking_S025    Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    Booking_S025    Verify Term & Condition

    Log    Step No.3 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    #Expected   
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    Booking_S025    Verify Select Parcel Type
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    Booking_S025    Verify Create Parcel Page Sender Step
    ...
    #Expected
    common.Verify Capture Screenshot    Booking_S025    Verify Create Parcel Page After Input Sender Step
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    Booking_S025    Verify Create Parcel Page Receiver Step When Select Home
    ...
    #Expected
    common.Verify Capture Screenshot    Booking_S025    Verify After Create Parcel Page Receiver Step
    ...
    ...    01523 ปากน้ำหลังสวน ปากน้ำ หลังสวน ชุมพร 86150    # Expected is ${Booking_S025['receiver_store_address']}
    ...    ${EMPTY}         # Expected Result is ${Booking.text_blank['parcel_size']}
    ...    ${Booking.text_blank['price_value']}
    ...    ${Booking.text_blank['buy_insurance']}
    ...    ${Booking.text_blank['cod_value']}
    common.Verify Capture Screenshot    Booking_S025    Verify Draft Parcel Receiver
    ...
    common.Verify Capture Screenshot    Booking_S025    Verify Data Sender
    ...
    common.Verify Capture Screenshot    Booking_S025    Verify Parcel Detail
    ...
    common.Verify Capture Screenshot    Booking_S025    Verify Create Parcel Page After Input Parcel Detail Step 
    ...
    common.Verify Capture Screenshot    Booking_S025    Verify Promotion
    ...
    # common.Verify Capture Screenshot    Booking_S025    Verify Selected Coupon And Code
    ...
    ...    0    # Expected is ${Booking_S025['discount_amount']}
    ...    0.00    # Expected is ${Booking_S025['discount_value']}
    ...
    common.Verify Capture Screenshot    Booking_S025    Verify Booking Detail Page After Booking Success
    ...
    common.Verify Capture Screenshot    Booking_S025    Verify Created Booking On Booking Delivery Page
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S025    Verify Booking Detail Page 
    ...
    common.Verify Capture Screenshot    Booking_S025    Verify Edit Booking List Popup  
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S025    Verify Booking Detail Page After Set Origin Shipping
    ...
    ...    ${Booking_S025['receiver_name']}
    ...    ${Booking_S025['receiver_phone']}
    ...    01523 7-11 ปากน้ำหลังสวน ปากน้ำ หลังสวน ชุมพร 86150    #${Booking_S025['store_address']}
    ...    ${Booking.label['non_cod']}
    ...    ${Booking.label['parcel_not_buy_insure']}
    ...    ${Booking_S025['parcel_detail_remark']}
    common.Verify Capture Screenshot    Booking_S025    Verify Parcel Label

    Log    Step No.22 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ" ใน PopUp "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    Booking_S025    Verify Print Screen
