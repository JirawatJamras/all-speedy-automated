...
Booking_S019
    ...
    ...    Defect083    Defect101    Defect126    Defect258    Defect278
    Log    Login
    ...
    b2c_booking_delivery_page.Click Save Button
    # Expected
    Log Defect No:  Defect042,Defect052,Defect278
    b2c_booking_detail_page.Verify Booking Detail Page After Draft
    ...    ${Booking['text_booking_list']}
    ...    ${Booking['text_draft_status']}
    ...    ${Booking.text_blank['text_chilled_parcel_id_4_start_unit']}
    ...
    common.Verify Capture Screenshot    booking    Booking_S019    16.1.Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S019    16.2.Verify Booking Detail Page After Booking Success
    ...
    ...    ${Booking.text_blank['origin_shipping']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S019    18.1.Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S019    18.2.Verify Booking Detail Page
    ...
    ${booking_time}    Get Booking Time
    # Expected
    Log Defect No:  Defect101,Defect126,Defect258
    b2c_booking_detail_page.Verify Booking Detail Page
    ...    ${Booking['text_title_booking_list']}
    ...    ${booking_id}
    ...    ${Booking['text_chilled_parcel_id_4_start_unit']}
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S019    20.1.Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S019    20.2.Verify Booking Detail Page After Set Origin Shipping
