...
Booking_S019
    ...
    common.Verify Capture Screenshot    Booking_S019    Verify Booking Page
    ...
    #Expected
    common.Verify Capture Screenshot    Booking_S019    Verify Create Parcel Page After Input Receiver Step
    ...
    b2c_booking_detail_page.Search Shipping Store    ${Booking_S019['store_code']}
    ...
    ...    ${Booking_S019['total_price_value']}
    ...    ${Booking_S019['store_code']}
    common.Scroll Window To Vertical    500
