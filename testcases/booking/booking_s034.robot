...
Booking_S034 
    ...
    common.Verify Capture Screenshot    Booking_S034    Verify Draft Parcel Receiver
    ...
    ...    0.00 บาท    # Expected result is: ${Booking.text_default['booking_price']}  # Expected result : ${Booking_S034['total_price_value1']}
