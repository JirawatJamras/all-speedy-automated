...
Booking_S034
    ...
    ...    Defect076    Defect077    Defect078    Defect084    Defect099    Defect101
    Log    Login
    ...
    common.Verify Capture Screenshot    booking    Booking_S034    1.Verify Booking Page For General Customer
    ...
    common.Verify Capture Screenshot    booking    Booking_S034    2.Verify Term & Condition
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S034    3.Verify Create Parcel Page Sender Step
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S034    4.Verify Create Parcel Page After Input Sender Step
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S034    5.Verify Create Parcel Page Receiver Step When Select Home
    ...
    common.Verify Capture Screenshot    booking    Booking_S034    6.Verify Create Parcel Page After Input Receiver Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S034    7.Verify Draft Parcel Receiver
    ...
    common.Verify Capture Screenshot    booking    Booking_S034    8.Verify Data Sender

    Log    Step No.9 กดปุ่ม "ถัดไป"
    b2c_booking_delivery_page.Click Next Button
    # Expected
    Log Defect No:  New Defect 17/12/2024 : Receiver address is displayed wrong tab.
    # b2c_booking_delivery_page.Verify Create Parcel Page Receiver Step When Select 7-ELEVEN Store
    # ...    ${Booking['text_title']}
    # ...    ${Booking['text_parcel_receiver_information']}
    # ...    ${Booking['text_phone_receiver']}
    ...
    # ...    ${EMPTY}
    # ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S034    10.Verify Parcel Detail

    Log    Step No.11 ขั้นตอนรายละเอียดพัสดุ
    b2c_booking_delivery_page.Select Parcel Size    ${Booking_S034['parcel_size']}
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S034    11.Verify Create Parcel Page After Input Parcel Detail Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S034    12.Verify Promotion
    ...
    ${booking_time}    Get Booking Time
    # Expected
    Log Defect No:  Defect042,Defect048,Defect063,Defect076,Defect084
    ...
    common.Verify Capture Screenshot    booking    Booking_S034    13.1.Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S034    13.2.Verify Booking Detail Page After Booking Success
    ...
    common.Verify Capture Screenshot    booking    Booking_S034    14.Verify Created Booking On Booking Delivery Page
    ...
    # ...    ${Booking.text_blank['origin_shipping']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S034    15.1.Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S034    15.2.Verify Booking Detail Page
    ...
    common.Verify Capture Screenshot    booking    Booking_S034    16.Verify Edit Booking List Popup  
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S034    17.1.Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S034    17.2.Verify Booking Detail Page After Set Origin Shipping
    ...
    common.Verify Capture Screenshot    booking    Booking_S034    18.Verify Parcel Label

    Log    Step No.19 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ" ใน PopUp "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S034    19.Verify Print Screen