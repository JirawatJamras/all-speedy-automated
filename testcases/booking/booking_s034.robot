...
Booking_S034 
    ...
    common.Verify Capture Screenshot    Booking_S034    Verify Booking Page For General Customer
    ...
    common.Verify Capture Screenshot    Booking_S034    Verify Term & Condition
    ...
    common.Verify Capture Screenshot    Booking_S034    Verify Select Parcel Type

    Log    Step No.4 กดปุ่ม "พัสดุทั่วไป"
    # b2c_booking_delivery_page.Select Parcel Type    ${Booking_S034['parcel_type']}
    # Expected
    ...
    # Expected
    common.Verify Capture Screenshot    Booking_S034    Verify Create Parcel Page After Input Sender Step
    ...
    b2c_booking_delivery_page.Click Store Receiver Lists    ${Booking_S034['receiver_store_address']}
    ...
    ...    01523 ปากน้ำหลังสวน ปากน้ำ หลังสวน ชุมพร 86150  # ${Booking_S034['receiver_store_address']}
    ...    ${EMPTY}         # Expected Result is ${Booking.text_blank['parcel_size']}
    ...    ${Booking.text_blank['price_value']}
    ...    ${Booking.text_blank['buy_insurance']}
    ...    ${Booking.text_blank['cod_value']}
    common.Verify Capture Screenshot    Booking_S034    Verify Draft Parcel
    ...
    common.Verify Capture Screenshot    Booking_S034    Verify Parcel Detail

    Log    Step No.12 ขั้นตอนรายละเอียดพัสดุ
    b2c_booking_delivery_page.Select Parcel Size    ${Booking_S034['parcel_size']}
    # Expected
    common.Verify Capture Screenshot    Booking_S034    Verify Create Parcel Page After Input Parcel Detail Step
    ...
    common.Verify Capture Screenshot    Booking_S034    Verify Promotion
    ...
    ...    ${Booking_S034['receiver_name']}
    ...    ${Booking_S034['receiver_phone']}
    ...    01523 ปากน้ำหลังสวน ปากน้ำ หลังสวน ชุมพร 86150  # Expected : ${Booking_S034['receiver_store_address']}
    ...
    ...    ${Booking.text_default['total_price_amount']}  # Expected result : ${Booking_S034['total_price_amount']}
    ...    ${Booking.text_default['total_price_value']}  # Expected result : ${Booking_S034['total_price_value1']}
    ...    ${EMPTY}  # Expected result : ${Booking.text_blank['store_code']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    Booking_S034    Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S034    Verify Booking Detail Page After Booking Success
    ...
    ...    ${booking_time}
    ...    ${Booking['text_parcel_status_select_shipping_origin']}
    ...    ${Booking_S034['booking_name']} ${booking_id}  # Expected result : ${Booking_S034['booking_name']}
    ...    ${Booking_S034['booking_item']}
    ...    ${Booking.text_default['booking_price']}  # Expected result : ${Booking_S034['total_price_value1']}
    common.Verify Capture Screenshot    Booking_S034    Verify Created Booking On Booking Delivery Page
    ...
    ...    ${Booking_S034['receiver_name']}
    ...    ${Booking_S034['receiver_phone']}
    ...    01523 ปากน้ำหลังสวน ปากน้ำ หลังสวน ชุมพร 86150  # Expected result : ${Booking_S034['receiver_store_address']}
    ...    ${Booking_S034['parcel_size']}
    ...    ${Booking.text_blank['price_value']}
    ...    ${Booking.text_blank['buy_insurance']}
    ...    ${Booking.text_blank['cod_value']}
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S034    Verify Booking Detail Page
    ...
    ...    ${EMPTY}  # Expected result : ${Booking_S034['parcel_type']}
    ...    ${Booking_S034['booking_name']} ${booking_id}  # Expected result : ${Booking_S034['booking_name']}
    ...    ${Booking['text_shipping_origin_aria']}
    common.Verify Capture Screenshot    Booking_S034    Verify Edit Booking List Popup  
    ...
    ...    ${Booking_S034['receiver_name']}
    ...    ${Booking_S034['receiver_phone']}
    ...    01523 ปากน้ำหลังสวน ปากน้ำ หลังสวน ชุมพร 86150  # Expected result : ${Booking_S034['receiver_store_full']}
    ...    ${Booking_S034['parcel_size']}
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    Booking_S034    Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S034    Verify Booking Detail Page After Set Origin Shipping
    ...
    ...    ${Booking_S034['receiver_name']}
    ...    ${Booking_S034['receiver_phone']}
    ...    01523 7-11 ปากน้ำหลังสวน ปากน้ำ หลังสวน ชุมพร 86150  # Expected result : ${Booking_S034['receiver_store_address']}
