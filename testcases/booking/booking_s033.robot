...
Booking_S033
    ...
    common.Verify Capture Screenshot    Booking_S033    Verify Draft Parcel Sender
    ...
    ...    0.00 บาท    # Expected result is: ${Booking.text_default['booking_price']}  # Expected result : ${Booking_S033['total_price_value1']}
