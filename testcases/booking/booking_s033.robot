...
Booking_S033
    ...
    common.Verify Capture Screenshot    Booking_S033    Verify Booking Page For General Customer
    ...
    common.Verify Capture Screenshot    Booking_S033    Verify Term & Condition
    ...
    common.Verify Capture Screenshot    Booking_S033    Verify Select Parcel Type

    Log    Step No.4 กดปุ่ม "พัสดุทั่วไป"
    # b2c_booking_delivery_page.Select Parcel Type    ${Booking_S033['parcel_type']}
    # Expected
    ...
    common.Verify Capture Screenshot    Booking_S033    Verify Click Choose Favorites
    ...
    common.Verify Capture Screenshot    Booking_S033    Verify Data Sender After Selecting From Favorites
    ...
    common.Verify Capture Screenshot    Booking_S033    Verify Draft Parcel
    ...
    ...    ${Booking_S033['sender_address']}
    ...    ${Booking_S033['sender_postcode_full']}
    common.Verify Capture Screenshot    Booking_S033    Verify Data Sender
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    Booking_S033    Verify Create Parcel Page Receiver Step When Select Home
    ...
    # Expected
    common.Verify Capture Screenshot    Booking_S033    Verify After Create Parcel Page Receiver Step
    ...
    common.Verify Capture Screenshot    Booking_S033    Verify Parcel Detail
    ...
    # Expected
    common.Verify Capture Screenshot    Booking_S033    Verify Create Parcel Page After Input Parcel Detail Step
    ...
    common.Verify Capture Screenshot    Booking_S033    Verify Promotion

    Log    Step No.14 ขั้นตอน Promotion
    # ระบุโค้ดส่วนลด : SPBH5B
    b2c_booking_delivery_page.Click Use Coupon  # Expected result : b2c_booking_delivery_page.Input Promotion    ${Booking_S033['promotion']}
    ...
    ...    ${Booking_S033.promotion_detail['parcel_size']}    # Expected result : ทุกขนาด
    ...    ${Booking_S033.promotion_detail['expired_date']}
    ...    ${Booking_S033.promotion_detail['condition']}  # Expected result : สำหรับลูกค้าที่เป็นกล่อง
    ...    ${Booking_S033.promotion_detail['period']}
    common.Verify Capture Screenshot    Booking_S033    Verify Selected Coupon And Code
    ...
    ...    ${Booking.text_default['discount_amount']}  # Expected result : ${Booking_S033['discount_amount']}
    ...    ${Booking.text_default['discount_value']}  # Expected result : NaN
    ...    ${Booking.text_default['insurance_fee_amount']}  # Expected result : ${Booking_S033['insurance_fee_amount']}
    ...    ${Booking.text_default['insurance_fee_value']}  # Expected result : ${Booking_S033['insurance_fee_value']}
    ...    ${Booking.text_default['cod_fee_amount']}
    ...    ${Booking.text_default['cod_fee_value']}
    ...    ${Booking.text_default['total_price_amount']}  # Expected result : ${Booking_S033['total_price_amount']}
    ...
    common.Verify Capture Screenshot    Booking_S033    Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S033    Verify Booking Detail Page After Booking Success
    ...
    ...    ${booking_time}
    ...    ${Booking['text_parcel_status_select_shipping_origin']}
    ...    ${Booking_S033['booking_name']} ${booking_id}  # Expected result : ${Booking_S033['booking_name']}
    ...    ${Booking_S033['booking_item']}
    ...    ${Booking.text_default['booking_price']}  # Expected result : ${Booking_S033['total_price_value1']}
    common.Verify Capture Screenshot    Booking_S033    Verify Created Booking On Booking Delivery Page
    ...
    ...    ${Booking.text_default['cod_fee_value']}
    ...    ${Booking.text_default['total_price_amount']}  # Expected result : ${Booking_S033['total_price_amount']}
    ...    ${Booking.text_default['total_price_value']}  # Expected result : ${Booking_S033['total_price_value1']}
    ...    ${EMPTY}  # Expected result : ${Booking.text_blank['store_code']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    Booking_S033    Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S033    Verify Booking Detail Page 
    ...
    ...    ${EMPTY}  # Expected result : ${Booking_S033['parcel_type']}
    ...    ${Booking_S033['booking_name']} ${booking_id}  # Expected result : ${Booking_S033['booking_name']}
    ...    ${Booking['text_shipping_origin_aria']}
    common.Verify Capture Screenshot    Booking_S033    Verify Edit Booking List Popup  
    ...
    ...    ${Booking_S033['store_code']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    Booking_S033    Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S033    Verify Booking Detail Page After Set Origin Shipping
    ...
    common.Verify Capture Screenshot    Booking_S033    Verify Parcel Label

    Log    Step No.21 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ" ใน PopUp "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    Booking_S033    Verify Print Screen
