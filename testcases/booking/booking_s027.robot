...
Booking_S027
    ...
    common.Verify Capture Screenshot    Booking_S027    Verify Create Parcel Page Receiver Step When Select Home
    ...
    ...    ${Booking_S027['total_price_value']}
    ...
    ...    ${Booking_S027['receiver_postcode_5_digits']}
