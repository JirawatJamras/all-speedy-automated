...
Booking_S015
    ...
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Term & Condition

    Step Test:    Step No.3 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    # Expected   
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Select Parcel Type
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Create Parcel Page Sender Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Click Choose Favorites
    ...
    common.Verify Capture Screenshot    booking    Booking_S015    Verify After Create Parcel Page Sender Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Draft Parcel Sender
    ...
    ...    ${Booking_S015['sender_address']}
    ...    ${Booking_S015['sender_postcode_full']}
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Data Sender
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Create Parcel Page Receiver Step When Select Home
    ...
    common.Verify Capture Screenshot    booking    Booking_S015    Verify After Create Parcel Page Receiver Step
    ...
    # ...    ${EMPTY}
    # ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Parcel Detail  
    ...
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Input Parcel Detail  
    ...
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Promotion
    ...
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Selected Coupon And Code

    Step Test:    Step No.15 กดปุ่ม "จองเลขพัสดุ"
    ...
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Booking Detail Page After Booking Success

    Step Test:    Step No.16 กดเมนู "จองการจัดส่งพัสดุ"
    b2c_home_page.Click Book Parcel Delivery
    b2c_booking_detail_page.Wait Until Loading Icon Success
    # Defect047
    # Expected
    ...
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Created Booking On Booking Delivery Page

    Step Test:    Step No.17 กดรายการบุ๊คกิ้งที่มีสถานะ "เลือกต้นทางจัดส่ง"
    ...
    # ...    ${Booking.text_blank['store_code']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Booking Detail Page

    Step Test:    Step No.18 กดปุ่ม "แก้ไขรายการบุ๊คกิ้ง"
    ...
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Edit Booking List Popup  

    Step Test:    Step No.19 "กรอกข้อมูลเพื้นที่ต้นทางการจัดส่ง"
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Booking Detail Page After Set Origin Shipping

    Step Test:    Step No.20 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ"
    ...
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Parcel Label

    Step Test:    Step No.21 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ" ใน PopUp "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S015    Verify Print Screen
