...
Booking_S015
    ...
    common.Verify Capture Screenshot    booking    Booking_S015    15.Verify Booking Detail Page After Booking Success
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S015    17.Verify Booking Detail Page
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S015    19.Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S015    19.Verify Booking Detail Page After Set Origin Shipping
