...
Booking_S036
    ...
    [Tags]    Booking    Customer_To_Customer    Regression    Unknown    Defect043    Defect045    Defect047    Defect048    Defect052    Defect055    Defect063    Defect076    
    ...    Defect077    Defect078    Defect084    Defect099    Defect101    Defect103
    Log    Login
    ...
    common.Verify Capture Screenshot    booking    Booking_S036    1.Verify Booking Page For General Customer
    ...
    common.Verify Capture Screenshot    booking    Booking_S036    2.Verify Term & Condition
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S036    3.Verify Create Parcel Page Sender Step
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S036    4.Verify After Create Parcel Page Sender Step
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S036    5.Verify Create Parcel Page Receiver Step When Select Home
    ...
    common.Verify Capture Screenshot    booking    Booking_S036    6.Verify After Create Parcel Page Receiver Step
    
    Log    Step No.7 กดปุ่ม "บันทึกร่าง"
    b2c_booking_delivery_page.Click Save Button
    # Expected
    Log Defect No:  Defect052,Defect076
    ...
    common.Verify Capture Screenshot    booking    Booking_S036    7.Verify Draft Parcel Receiver
    ...
    common.Verify Capture Screenshot    booking    Booking_S036    8.Verify Data Sender
    ...
    common.Verify Capture Screenshot    booking    Booking_S036    9.Verify Data Receiver When Select 7-ELEVEN Store
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S036    10.Verify Parcel Detail
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S036    11.Verify Create Parcel Page After Input Parcel Detail Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S036    12.Verify Promotion
    ...
    ${booking_time}    Get Booking Time
    # Expected
    Log Defect No:  Defect048,Defect063,Defect076,Defect084,Defect103
    ...
    common.Verify Capture Screenshot    booking    Booking_S036    14.Verify Created Booking On Booking Delivery Page
    ...
    common.Verify Capture Screenshot    booking    Booking_S036    16.Verify Edit Booking List Popup  
    ...
    ${booking_time}    Get Booking Time
    # Expected
    Log Defect No:  Defect076,Defect078,Defect084,Defect101
    b2c_booking_detail_page.Verify Booking Detail Page When Select 7-ELEVEN Store
    ...    ${Booking['text_title_booking_list']}
    ...    ${booking_id}
    ...    ${Booking['text_dry_parcel_id_4_start_unit']}
    ...
    common.Verify Capture Screenshot    booking    Booking_S036    18.Verify Parcel Label

    Log    Step No.19 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ" ใน PopUp "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S036    19.Verify Print Screen