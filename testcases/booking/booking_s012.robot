...
Booking_S012
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Term & Condition

    Step Test:    Step No.3 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    # Expected   
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Select Parcel Type
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Create Parcel Page Sender Step
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S012    Verify After Create Parcel Page Sender Step
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Create Parcel Page Receiver Step When Select Home

    Step Test:    Step No.7 ขั้นตอนข้อมูลผู้รับพัสดุ
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Favorites Receiver PopUp
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Choose Receiver From Favorites
    ...
    # ...    ${EMPTY}
    # ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Parcel Detail Page of Create Parcel [Dry Parcel]
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Select Parcel Size And Input COD
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Draft Parcel After Input Parcel Detail
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Data Sender
    ...
    # b2c_booking_delivery_page.Verify Textbox Value On Parcel Detail Step [Dry Parcel]
    # ...    0    #${EMPTY}
    # ...    ${Booking_S012['parcel_cod_verify2']}
    # ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Parcel Detail Page of Create Parcel [Dry Parcel]
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Promotion
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Booking Detail Page After Booking Success
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Created Booking On Booking Delivery Page
    ...
    # ...    ${Booking.text_blank['store_code']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Booking Detail Page
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Edit Booking List Popup  
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Booking Detail Page After Set Origin Shipping
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Parcel Label

    Step Test:    Step No.22 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ" ใน PopUp "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S012    Verify Print Screen