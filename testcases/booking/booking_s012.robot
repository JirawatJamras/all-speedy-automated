...
Booking_S012
    ...
    [Tags]    Booking    Business_To_Customer    UAT    Unknown    Defect043    Defect045    Defect047    Defect048    Defect054    Defect055    Defect063    Defect077    Defect078    Defect258    Defect267
    Log    Login
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    1.Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    2.Verify Term & Condition

    Log    Step No.3 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    # Expected   
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    booking    Booking_S012    3.Verify Select Parcel Type
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S012    4.Verify Create Parcel Page Sender Step
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S012    5.Verify After Create Parcel Page Sender Step
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S012    6.Verify Create Parcel Page Receiver Step When Select Home
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    7.Verify Favorites Receiver PopUp
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    8.Verify Choose Receiver From Favorites
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S012    9.Verify Parcel Detail Page of Create Parcel [Dry Parcel]
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S012    10.Verify Select Parcel Size And Input COD
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    11.Verify Draft Parcel After Input Parcel Detail
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    12.Verify Data Sender
    ...
    ...    ${Booking_S012['receiver_name']}
    ...    ${Booking_S012['receiver_store_full']}
    common.Verify Capture Screenshot    booking    Booking_S012    13.Verify Create Parcel Page Receiver Step When Select Home
    ...
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S012    14.Verify Parcel Detail Page of Create Parcel [Dry Parcel]
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    15.Verify Promotion
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    16.1.Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S012    16.2.Verify Booking Detail Page After Booking Success
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    17.Verify Created Booking On Booking Delivery Page
    ...
    ...    ${Booking.text_blank['origin_shipping']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S012    18.1.Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S012    18.2.Verify Booking Detail Page
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    19.Verify Edit Booking List Popup  
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S012    20.1.Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S012    20.2.Verify Booking Detail Page After Set Origin Shipping
    ...
    common.Verify Capture Screenshot    booking    Booking_S012    21.Verify Parcel Label

    Log    Step No.22 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ" ใน PopUp "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S012    22.Verify Print Screen