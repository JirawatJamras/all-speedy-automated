...
Booking_S009
    ...
    common.Verify Capture Screenshot    Booking_S009    Verify Click Choose Favorites
    ...
    common.Verify Capture Screenshot    Booking_S009    Verify After Create Parcel Page Sender Step
    ...
    common.Verify Capture Screenshot    Booking_S009    Verify Favorites Receiver PopUp
    ...
    common.Verify Capture Screenshot    Booking_S009    Verify Choose Receiver From Favorites
    ...
    common.Verify Capture Screenshot    Booking_S009    Verify Draft Parcel Receiver
    ...
    ...    ${Booking_S009['sender_address']}
    ...    ${Booking_S009['sender_postcode_full']}
    common.Verify Capture Screenshot    Booking_S009    Verify Data Sender
    ...
    ...    ${Booking_S009['receiver_address']}
    ...    ${Booking_S009['receiver_postcode_full']}
    common.Verify Capture Screenshot    Booking_S009    Verify Data Receiver When Select 7-ELEVEN Store
    ...
    common.Verify Capture Screenshot    Booking_S009    Verify Parcel Detail
    ...
    # Expected
    common.Verify Capture Screenshot    Booking_S009    Verify Create Parcel Page After Input Parcel Detail Step
    ...
    # common.Verify Capture Screenshot    Booking_S009    Verify Selected Coupon And Code
    ...
    ...    0    # Expected result is: ${Booking_S009['insurance_fee_amount']}
    ...    0.00    # Expected result is: ${Booking_S009['insurance_fee_value']}
    ...    0    # Expected result is: ${Booking_S009['cod_fee_amount']}
    ...
    common.Verify Capture Screenshot    Booking_S009    Verify Booking Detail Page After Booking Success
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S009    Verify Booking Detail Page 
    ...
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S009    Verify Booking Detail Page After Set Origin Shipping
    ...
    # Expected
    common.Verify Capture Screenshot    Booking_S009    Verify Print Screen