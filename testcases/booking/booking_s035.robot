...
Booking_S035 
    ...
    ...    ${Booking.text_blank['receiver_store_address']}  # ${Booking_S035['receiver_store_address']}
    ...    ${EMPTY}  # Expected Result is ${Booking.text_blank['parcel_size']}
    ...    ${Booking.text_blank['price_value']}
    ...    ${Booking.text_blank['buy_insurance']}
    ...    ${Booking.text_blank['cod_value']}
    common.Verify Capture Screenshot    Booking_S035    Verify Draft Parcel Sender
    ...
    # Expected
    common.Verify Capture Screenshot    Booking_S035    Verify Create Parcel Page After Input Parcel Detail Step
    ...
    b2c_booking_delivery_page.Click Use Coupon  # Expected result : b2c_booking_delivery_page.Input Promotion    ${Booking_S035['promotion']}
    ...
    ...    01523 ปากน้ำหลังสวน ปากน้ำ หลังสวน ชุมพร 86150  # Expected result : ${Booking_S035['receiver_store_address']}
    ...    ${Booking_S035['parcel_size']}
    ...    ${Booking.text_blank['price_value']}
    ...    ${Booking.text_blank['buy_insurance']}
    ...    ${Booking.text_blank['cod_value']}
    ...    ${Booking['text_title_booking_summary']}
    ...    ${Booking.text_default['discount_amount']}  # Expected result : ${Booking_S035['discount_amount']}
    ...    ${Booking.text_default['discount_value']}  # Expected result : NaNN
    ...    ${Booking.text_default['insurance_fee_amount']}
    ...    ${Booking.text_default['insurance_fee_value']}
    ...    ${Booking.text_default['cod_fee_amount']}
    ...    ${Booking.text_default['cod_fee_value']}
    ...    ${Booking.text_default['total_price_amount']}  # Expected result : ${Booking_S035['total_price_amount']}
    ...
    ...    ${booking_time}
    ...    ${Booking['text_parcel_status_select_shipping_origin']}
    ...    ${Booking_S035['booking_name']} ${booking_id}  # Expected result : ${Booking_S035['booking_name']}
    ...    ${Booking_S035['booking_item']}
    ...    0.00 บาท    # Expected result is: ${Booking.text_default['booking_price']}  # Expected result : ${Booking_S035['total_price_value1']}
    ...
    ...    ${Booking_S035['receiver_name']}
    ...    ${Booking_S035['receiver_phone']}
    ...    01523 ปากน้ำหลังสวน ปากน้ำ หลังสวน ชุมพร 86150  # Expected result : ${Booking_S035['receiver_store_full']}
    ...    ${Booking_S035['parcel_size']}
    ...
    ...    ${Booking_S035['receiver_name']}
    ...    ${Booking_S035['receiver_phone']}
    ...    01523 7-11 ปากน้ำหลังสวน ปากน้ำ หลังสวน ชุมพร 86150  # Expected result : ${Booking_S035['receiver_store_address']}
