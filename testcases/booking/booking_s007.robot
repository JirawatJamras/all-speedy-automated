...
Booking_S007
    ...
    [Tags]    Booking    Business_To_Customer    Regression    Unknown    Defect043    Defect045    Defect047    Defect048    Defect050    Defect052    Defect055    Defect063    
    ...   Defect072    Defect075    Defect078    Defect101    Defect258
    Log    Login
    ...
    common.Verify Capture Screenshot    booking    Booking_S007    1.Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    booking    Booking_S007    3.Verify Select Parcel Type
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S007    4.Verify Create Parcel Page Sender Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S007    5.Verify Click Choose Favorites
    ...
    common.Verify Capture Screenshot    booking    Booking_S007    6.Verify After Create Parcel Page Sender Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S007    7.Verify Draft Parcel Sender
    ...
    ...    ${Booking_S007['sender_address']}
    ...    ${Booking_S007['sender_postcode_full']}
    common.Verify Capture Screenshot    booking    Booking_S007    8.Verify Data Sender
    ...
    # ...    ${EMPTY}
    # ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S007    9.Verify Create Parcel Page Receiver Step When Select Home
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S007    10.Verify After Input Receiver Data
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S007    11.Verify Parcel Detail  
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S007    12.Verify Input Parcel Detail  
    ...
    common.Verify Capture Screenshot    booking    Booking_S007    13.Verify Promotion
    ...
    common.Verify Capture Screenshot    booking    Booking_S007    14.Verify Selected Coupon And Code
    ...
    ...    ${Booking_S007['total_price_value1']}
    ...    ${Booking.text_blank['origin_shipping']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S007    15.1.Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S007    15.2.Verify Booking Detail Page After Booking Success
    ...
    common.Verify Capture Screenshot    booking    Booking_S007    16.Verify Created Booking On Booking Delivery Page
    ...
    ...    ${Booking.text_blank['origin_shipping']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S007    17.1.Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S007    17.2.Verify Booking Detail Page
    ...
    common.Verify Capture Screenshot    booking    Booking_S007    18.Verify Edit Booking List Popup  
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S007    19.1.Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S007    19.2.Verify Booking Detail Page After Set Origin Shipping
    ...
    common.Verify Capture Screenshot    booking    Booking_S007    20.Verify Parcel Label
    
    Log    Step No.21 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ" ใน PopUp "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S007    21.Verify Print Screen