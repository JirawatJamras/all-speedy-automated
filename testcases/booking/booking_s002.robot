...
Booking_S002
    ...
    [Tags]    Booking    Business_To_Customer    UAT    Unknown    Defect042    Defect043    Defect045    Defect047    Defect048    
    ...    Defect052    Defect055    Defect056    Defect063    Defect078    Defect101    Defect258    Defect261?
    Log    Login
    ...
    common.Verify Capture Screenshot    booking    Booking_S002    14.1.Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S002    14.2.Verify Booking Detail Page After Booking Success
    ...
    ...    ${Booking.text_blank['origin_shipping']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S002    16.1.Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S002    16.2.Verify Booking Detail Page
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S002    18.1.Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S002    18.2.Verify Booking Detail Page After Set Origin Shipping
