...
Booking_S002
    ...
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Term & Condition

    Step Test:    Step No.3 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    # Expected   
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Select Parcel Type
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Create Parcel Page Sender Step
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Create Parcel Page After Input Sender Step
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Create Parcel Page Receiver Step When Select Home
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Create Parcel Page After Input Receiver Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Draft Parcel Receiver
    ...
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Data Sender
    ...
    ...    ${Booking_S002['receiver_address']}
    ...    ${Booking_S002['receiver_postcode_full']}
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Data Receiver When Select Home
    ...
    # ...    ${EMPTY}
    # ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Parcel Detail

    Step Test:    Step No.12 ขั้นตอนรายละเอียดพัสดุ
    b2c_booking_delivery_page.Select Parcel Size    ${Booking_S002['parcel_size']}
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Create Parcel Page After Input Parcel Detail Step 
    ...
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Promotion
    ...
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Booking Detail Page After Booking Success
    ...
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Created Booking On Booking Delivery Page
    ...
    # ...    ${Booking.text_blank['store_code']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Booking Detail Page
    ...
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Edit Booking List Popup  
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Booking Detail Page After Set Origin Shipping
    ...
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Parcel Label

    Step Test:    Step No.20 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ" ใน PopUp "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S002    Verify Print Screen