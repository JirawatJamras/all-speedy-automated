...
Booking_S003
    ...
    [Tags]    Booking    Business_To_Customer    Regression    Unknown    Defect042    Defect043    Defect045    Defect047    Defect048    Defect049    Defect050    Defect052    
    ...    Defect053    Defect054    Defect055    Defect072    Defect075    Defect078    Defect258
    Log    Login
    ...
    common.Verify Capture Screenshot    booking    Booking_S003    1.Verify Booking Page For Business Customer
    ...
    common.Verify Capture Screenshot    booking    Booking_S003    2.Verify Term & Condition

    Log    Step No.3 กดปุ่ม "ยอมรับเงื่อนไขการใช้บริการ"
    b2c_booking_delivery_page.Click Accept Terms of Service
    # Expected
    b2c_booking_delivery_page.Verify Select Parcel Type
    common.Verify Capture Screenshot    booking    Booking_S003    3.Verify Select Parcel Type
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S003    4.Verify Create Parcel Page Sender Step
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S003    5.Verify After Create Parcel Page Sender Step
    ...
    common.Verify Capture Screenshot    booking    Booking_S003    6.Verify Draft Parcel Sender
    ...
    common.Verify Capture Screenshot    booking    Booking_S003    7.Verify Data Sender
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S003    8.Verify Create Parcel Page Receiver Step When Select Home
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S003    9.Verify After Create Parcel Page Receiver Step
    ...
    ...    ${EMPTY}
    ...    ${EMPTY}
    common.Verify Capture Screenshot    booking    Booking_S003    10.Verify Parcel Detail
    ...
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S003    11.Verify Select Parcel Size And Input Remark
    ...
    common.Verify Capture Screenshot    booking    Booking_S003    12.Verify Promotion
    ...
    common.Verify Capture Screenshot    booking    Booking_S003    13.Verify Selected Coupon And Code
    ...
    ${booking_time}    Get Booking Time
    # Expected
    Log Defect No:  Defect048,Defect053,Defect054,Defect063,Defect072,Defect075,Defect258
    ...
    common.Verify Capture Screenshot    booking    Booking_S003    14.1.Verify Booking Summary After Booking Success
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S003    14.2.Verify Booking Detail Page After Booking Success
    ...
    common.Verify Capture Screenshot    booking    Booking_S003    15.Verify Created Booking On Booking Delivery Page
    ...
    ...    ${Booking.text_blank['origin_shipping']}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S003    16.1.Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S003    16.2.Verify Booking Detail Page 
    ...
    common.Verify Capture Screenshot    booking    Booking_S003    17.Verify Edit Booking List Popup  
    ...
    ${booking_time}    Get Booking Time
    # Expected
    Log Defect No:  Defect049,Defect078,Defect258
    b2c_booking_detail_page.Verify Booking Detail Page
    ...    ${Booking['text_title_booking_list']}
    ...    ${booking_id}
    ...    ${Booking['text_dry_parcel_id_4_start_unit']}
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    booking    Booking_S003    18.1.Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    booking    Booking_S003    18.2.Verify Booking Detail Page After Set Origin Shipping
    ...
    common.Verify Capture Screenshot    booking    Booking_S003    19.Verify Parcel Label
    
    Log    Step No.20 กดปุ่ม "พิมพ์ใบจ่ายหน้าพัสดุ" ใน PopUp "พิมพ์ใบจ่ายหน้าพัสดุ"
    b2c_booking_detail_page.Click Print Label On Popup
    # Expected
    common.Verify Capture Screenshot    booking    Booking_S003    20.Verify Print Screen