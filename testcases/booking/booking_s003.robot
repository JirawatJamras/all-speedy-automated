...
Booking_S003
    ...
    [Tags]    Booking    UAT    Review_Pass    BEW
    Log    Login
    ...
    common.Verify Capture Screenshot    Booking_S003    Verify Data Sender
    ...
    common.Verify Capture Screenshot    Booking_S003    Verify Created Booking On Booking Delivery Page
    ...
    ...    ${EMPTY}
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    Booking_S003    Verify Booking Summary
    common.Scroll Window To Vertical    0
    common.Verify Capture Screenshot    Booking_S003    Verify Booking Detail Page 
    ...
    common.Verify Capture Screenshot    Booking_S003    Verify Edit Booking List Popup  
    ...
    common.Scroll Window To Vertical    500
    common.Verify Capture Screenshot    Booking_S003    Verify Booking Summary After Set Origin Shipping
    common.Scroll Window To Vertical    0
