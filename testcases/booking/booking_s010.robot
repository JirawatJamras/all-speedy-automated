...
Booking_S010
    ...
    common.Verify Capture Screenshot    Booking_S010    Verify Booking Page
    ...
    common.Verify Capture Screenshot    Booking_S010    Verify Create Parcel Page Receiver Step
    ...
    # b2c_booking_delivery_page.Click Postcode Receiver Lists    ${Booking_S010['receiver_postcode_full']}
    #Expected
    ...
    common.Verify Capture Screenshot    Booking_S010    Verify Draft Parcel Sender
    ...
    ...    ${Booking_S010['total_price_value']}
    ...    ${Booking_S010['store_code']}
    common.Scroll Window To Vertical    500
    ...
    ...    ${Booking_S010['receiver_postcode_5_digits']}
