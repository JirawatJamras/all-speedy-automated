...
${card_receiver_send_home_favorite_page}    (//strong[text()='{favorite_name}']/../../..//*[@stroke='currentColor']/../../../../..//span[text()='{name}']/../..//span[text()='{phone}']/../../../..//span[text()='{address}']/../../../../..)[1]
${card_receiver_send_store_favorite_page}    (//strong[text()='{favorite_name}']/../../..//*[@loading='lazy']/../../../../..//span[text()='{name}']/../..//span[text()='{phone}']/../../../..//span[text()='{address}']/../../../../..)[1]
