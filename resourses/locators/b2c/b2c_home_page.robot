...
${b2c_txt_profile_name}     //h1[@class='font-semibold w-1/2 text-[25px]'][contains(text(),'ชื่อ')]
${b2c_txt_profile_phone}     //h1[@class='font-semibold w-1/2 text-[25px]'][contains(text(),'เบอร์โทรศัพท์')]
${b2c_txt_profile_mail}     //h1[@class='font-semibold w-1/2 text-[25px]'][normalize-space()='E-mail']
${b2c_txt_profile_position}     //h1[@class='font-semibold w-1/2 text-[25px]'][contains(text(),'ตำแหน่งงาน')]
