...
${b2c_txt_booking_list}    //div[@class='ant-space css-1hobygo ant-space-horizontal ant-space-align-center ant-space-gap-row-small ant-space-gap-col-small']//strong[contains(text(),'รายการบุ๊คกิ้ง')]
...
${b2c_txt_booking_summary_booking_detail_page}    //*[@class='hidden sm:inline']//strong[text()='สรุปรายการบุ๊คกิ้ง']
