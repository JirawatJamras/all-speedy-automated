...
${dps_btn_print_delivery_list}    //div[contains(@class,'ant-card')]//tr[td[1]='{value_export_to}' and td[2]='{value_transport}' and contains(td[6],'{value_date}') and //td[7]//h1[contains(normalize-space(), '{value_status}')]  ]//td[8]//button
${dps_print_success_alert}    