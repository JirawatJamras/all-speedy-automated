...
${dps_txt_list_data_move_status}    //div[@aria-hidden='false']//td//*[contains(text(),'{status}')]/../../..//td[text()='{tracking}']/..//td[text()='-']/..//td[text()='CP ALL']/..//td[text()='Speedy']/..//td[text()='กล่อง M']/..//td[contains(text(),'22/11/2567')]
