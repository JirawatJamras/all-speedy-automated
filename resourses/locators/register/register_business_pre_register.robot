...
${register_dropdown_company_title_name}    //input[@id='companyTitleName']//..//..
${register_dropdown_title_name}    //input[@id='titleName']//..//..
${register_dropdown_choice_title_name}     //div[text()='{value}'][@class='ant-select-item-option-content']
${register_dropdown_company_address_full}    //input[@id='companyAddress_full']
${register_dropdown_choice_company_address_full}    //div[text()='{value}'][@class='ant-select-item-option-content']

${register_txtbox_company_name}    //input[@id='companyName']
${register_txtbox_tax_identification_number}    //input[@id='idNumber']
${register_txtbox_company_address}    //input[@id='companyAddress_addressInfo']
${register_txtbox_first_name}    //input[@id='firstName']
${register_txtbox_last_name}    //input[@id='lastName']
${register_txtbox_email}    //input[@id='email']
${register_txtbox_mobile_no}    //input[@id='mobileNo']
${register_txtbox_mobile_ext}    //input[@id='mobileExt']

#path not correct
${register_txt_success}    //div[@class='ant-row ant-row-center css-1hobygo']
