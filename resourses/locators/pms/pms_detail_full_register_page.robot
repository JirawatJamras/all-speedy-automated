...
${pms_txt_remark3_full_regis}    //label[@for='remark3']
${pms_txt_remark4_full_regis}    //label[@for='remark4']
...
${pms_txt_list_contact_heading_full_regis}    //thead[@class='ant-table-thead']//th[text()='ชื่อผู้ติดต่อ']/..
${pms_txt_list_contact_info_full_regis}    //tbody[@class='ant-table-tbody']

${pms_txt_date_active_full_regis}    //label[@for='dateActiveNo']
${pms_txt_date_partnertype_full_regis}    //label[@for='partnerType']
#Inprogress
