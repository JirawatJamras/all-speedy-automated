...
${dps_txt_list_receiving_cycle_waiting}    //div[@aria-hidden='false']//tr[contains(@class,'ant-table-row ant-table-row-level-0')]//td[text()='{company_name}']//..//td[text()='{address}']//..//td[text()='{sub_district}']//..//td[text()='{district}']//..//td[text()='{province}']//..//td[text()='{postcode}']//..//td[text()='{tomorrow}']//..//td[text()='{receiving_time}']//..//td//div[text()='{receiving_type}']//..//..//td[text()='{courier}']//..//td[text()='{number_of_parcel}']//..//td//div[contains(text(),'{status}')]//..//..//button[@type='button']
