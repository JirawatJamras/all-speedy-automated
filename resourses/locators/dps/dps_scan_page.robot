...
${dps_txt_value_parcel_id}    //span[contains(@class,'ant-typography') and text()='{value}']
${dps_txt_value_customer_id}    //span[contains(@class,'ant-typography') and text()='{value}']    
...
${dps_txt_value_warehouse_crossdock}    (//span[contains(@class,'ant-typography') and text()='{value}' ])[1]
${dps_txt_value_warehouse_destination}    //input[@id='rc_select_1']/../../span[2]
${dps_txt_value_parcel_status}    //span[contains(@class,'ant-typography')]//p[text()='{value}']
${dps_txt_value_courier}    //input[@id='rc_select_2']/../../span[2]
${dps_txt_value_pouch_number}    (//span[contains(@class,'ant-typography') and text()='{value}'])[2]
${dps_txt_value_receiving_date}    //span[contains(@class,'ant-typography') and text()='{value}']
${dps_txt_value_warehouse_source}    (//span[contains(@class,'ant-typography') and text()='{value}' ])[3]
${dps_txt_value_send_parcel_to}    //span[contains(@class,'ant-typography') and text()='{value}']
...
${dps_txt_label_shipping_destination_in_scan_in_scan_page}    (//div[@aria-hidden='false']//span[contains(@class,'ant-typography text-lg')])[31]
${dps_txt_label_receiver_address_in_scan_in_scan_page}    (//div[@aria-hidden='false']//span[contains(@class,'ant-typography text-lg')])[33]
