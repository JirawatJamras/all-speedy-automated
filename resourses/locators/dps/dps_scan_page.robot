...
${dps_txt_wiating_list_to_scan_out_in_scan_out_page}    //td[text()='{parcel_number}']/..//td//div[text()='{pouch_number}']/../..//td[text()='{import_from}']/..//td[text()='{deliver}']/..//td[text()='{parcel_owner}']/..//td[text()='{parcel_size}']/..//td[contains(text(),'{update_date}')]
${dps_txt_parecl_stauts_of_wiating_list_to_scan_out_in_scan_out_page}    //td[text()='{parcel_number}']/..//td//div[text()='{pouch_number}']/../..//td[text()='{import_from}']/..//td[text()='{deliver}']/..//td[text()='{parcel_owner}']/..//td[text()='{parcel_size}']/..//td[contains(text(),'{update_date}')]/..//td[8]
${dps_txt_update_date_of_wiating_list_to_scan_out_in_scan_out_page}    //td[text()='{parcel_number}']/..//td//div[text()='{pouch_number}']/../..//td[text()='{import_from}']/..//td[text()='{deliver}']/..//td[text()='{parcel_owner}']/..//td[text()='{parcel_size}']/..//td[7]
