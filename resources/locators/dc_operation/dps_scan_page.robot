...
${dps_txtbox_status_move_status}    //input[@id='status']
...
${dps_btn_search_on_pouch_detail_on_scan_page}    //strong[text()='{label}']/../../../../..//span[text()='{value}']/..
...
${dps_btn_tab_in_scan_page}    //div[@role='tab' and text()='{tab}']
...
${dps_txt_pouch_value_label}    //span[text()='{text}']/..//span[text()='{value}']
...
${dps_txt_waiting_list_to_scan_out_in_scan_out_page}    //tr[td[1]='{parcel_number}' and td[2]='{pouch_number}' and td[3]='{import_from}' and td[4]='{deliver}' and td[5]='{parcel_owner}' and td[6]='{parcel_size}' and contains(td[7], '{update_date}') and td[8]//h1[contains(normalize-space(),'{parcel_status}')]]
${dps_txt_label_waiting_list_to_scan_out_in_scan_out_page}    //tr[th[1]='{parcel_number}' and th[2]='{pouch_number}' and th[3]='{import_from}' and th[4]='{deliver}' and th[5]='{parcel_owner}' and th[6]='{parcel_size}' and th[7]='{update_date}' and th[8]='{parcel_status}']
${dps_txt_update_date_of_waiting_list_to_scan_out_in_scan_out_page}    //tr[td[1]='{parcel_number}' and td[2]='{pouch_number}' and td[3]='{import_from}' and td[4]='{deliver}' and td[5]='{parcel_owner}' and td[6]='{parcel_size}']//td[7]
...
${dps_txt_crossdock_warehouse_in_pouch_detail_scan_in_page}    //strong[text()='{value}']
...
${dps_txt_data_crossdock_warehouse_in_pouch_detail_scan_in_page}    //strong[text()='{value}']/../../../div[2]/span
${dps_txt_thead_parcel_in_pouch_scan_in_page}    //tr[th='{tracking}' and th='{destination_warehouse}' and th='{parcel_size}' and th='{type}' and th='{parcel_status}']
${dps_txt_data_parcel_in_pouch_scan_in_page}        //tr[td[1][normalize-space()='{tracking}'] and     td[2][normalize-space()='{destination_warehouse}'] and     td[3][normalize-space()='{parcel_size}'] and     td[4][normalize-space()='{type}'] and     td[5]//h1[contains(normalize-space(), '{parcel_status}')] ]
...
${dps_txt_pouch_number_in_scan_page}    (//span[text()='{pouch_status}']/../../../..//span[text()='{pouch_number}']/../..//span[contains(text(),'{pouch_id}')])[1]
